...
package local_project.extract_schema_to_mapping_0_1;
...
/**
 * Job: EXTRACT_Schema_To_Mapping Purpose: <br>
 * Description: extract an excel file to explain the mapping done <br>
 * @author 
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class EXTRACT_Schema_To_Mapping implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (InFileFolder != null) {

				this.setProperty("InFileFolder", InFileFolder.toString());
		...
		public String InFileFolder;

		public String getInFileFolder() {
			return this.InFileFolder;
		}
	...
	private final String jobName = "EXTRACT_Schema_To_Mapping";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					EXTRACT_Schema_To_Mapping.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(EXTRACT_Schema_To_Mapping.this,
	...
	public static class row_Implicit_Context_RegexStruct implements
		...
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_EXTRACT_Schema_To_Mapping = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_EXTRACT_Schema_To_Mapping = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_EXTRACT_Schema_To_Mapping.length) {
					if (length < 1024
							&& commonByteArray_LOCAL_PROJECT_EXTRACT_Schema_To_Mapping.length == 0) {
						commonByteArray_LOCAL_PROJECT_EXTRACT_Schema_To_Mapping = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_EXTRACT_Schema_To_Mapping = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_LOCAL_PROJECT_EXTRACT_Schema_To_Mapping,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_EXTRACT_Schema_To_Mapping) {
						...
						if (tmp_key_Implicit_Context_Context != null) {
							try {
								...
								if (key_Implicit_Context_Context != null
										&& "InFileFolder"
												.equals(key_Implicit_Context_Context)) {
									context.InFileFolder = value_Implicit_Context_Context;
								}
	...
	public static class ConversionStruct implements
			routines.system.IPersistableRow<ConversionStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_EXTRACT_Schema_To_Mapping = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_EXTRACT_Schema_To_Mapping = new byte[0];

		public String originalDbColumnName;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_EXTRACT_Schema_To_Mapping) {
				...
				try {
					...
					this.originalDbColumnName = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.originalDbColumnName, dos);
		 ...
		 * Compare keys
		 */
		public int compareTo(ConversionStruct other) {
	...
	public void tFileInputXML_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				ConversionStruct Conversion = new ConversionStruct();
				...
				String fileName_tFileOutputExcel_1 = "C:/Users/Cillia/Desktop/Job_TechnipFMC/workpackage.xls";
				...
				writableSheet_tFileOutputExcel_1 = writeableWorkbook_tFileOutputExcel_1
						.getSheet("workpackage");
				if (writableSheet_tFileOutputExcel_1 == null) {
					writableSheet_tFileOutputExcel_1 = writeableWorkbook_tFileOutputExcel_1
							.createSheet("workpackage",
				...
				try {
					filename_tFileInputXML_1 = "C:/Users/Cillia/Desktop/Job_TechnipFMC/workpackage.xml";
				} catch (java.lang.Exception e) {
				...
				if (isValidFile_tFileInputXML_1) {
					...
					org.dom4j.XPath x_tFileInputXML_1 = doc_tFileInputXML_1
							.createXPath(nsTool_tFileInputXML_1
									.addDefaultNSPrefix("/schema/column"));
					x_tFileInputXML_1
					...
					for (org.dom4j.tree.AbstractNode temp_tFileInputXML_1 : nodeList_tFileInputXML_1) {
						if (nb_line_tFileInputXML_1 >= 1000) {
						...
						Conversion = new ConversionStruct();
						try {
							...
							if (xml_api_tFileInputXML_1
								...
								Conversion.originalDbColumnName = null;
							} else if (xml_api_tFileInputXML_1
									.isEmpty(node_tFileInputXML_1)) {
								Conversion.originalDbColumnName = "";
							} else if (xml_api_tFileInputXML_1
									.isMissing(node_tFileInputXML_1)) {
								Conversion.originalDbColumnName = null;
							} else {
								Conversion.originalDbColumnName = str_tFileInputXML_1;
							}
						...
						if (Conversion != null) {
							...
							if (execStat) {
								runStat.updateStatOnConnection("Conversion"
										+ iterateId, 1, 1);
							}

							if (Conversion.originalDbColumnName != null) {
	...
	public static void main(String[] args) {
		final EXTRACT_Schema_To_Mapping EXTRACT_Schema_To_MappingClass = new EXTRACT_Schema_To_Mapping();

		int exitCode = EXTRACT_Schema_To_MappingClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = EXTRACT_Schema_To_Mapping.class
					.getClassLoader().getResourceAsStream(
							"local_project/extract_schema_to_mapping_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = EXTRACT_Schema_To_Mapping.class
						.getClassLoader()
						.getResourceAsStream(
			...
			context.setContextType("FilePath", "id_File");
			...
			context.setContextType("InFileFolder", "id_String");

			context.InFileFolder = (String) context.getProperty("InFileFolder");
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("InFileFolder")) {
				context.InFileFolder = (String) parentContextMap
						.get("InFileFolder");
			}
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : EXTRACT_Schema_To_Mapping");
		}
...
/************************************************************************************************
 * 69086 characters generated by Talend Open Studio for Data Integration on the
 * 15 novembre 2019 09:20:15 CET
 ************************************************************************************************/
