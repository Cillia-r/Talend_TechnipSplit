...
package local_project.load_formerposition_0_1;
...
/**
 * Job: LOAD_FormerPosition Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class LOAD_FormerPosition implements TalendJob {
...
public String getOutput(){
	...
	private final String jobName = "LOAD_FormerPosition";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				LOAD_FormerPosition.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(LOAD_FormerPosition.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tAdvancedHash_Contact_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void tAdvancedHash_Account_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class row_Implicit_Context_RegexStruct implements routines.system.IPersistableRow<row_Implicit_Context_RegexStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_LOAD_FormerPosition = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_LOAD_FormerPosition = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_LOAD_FormerPosition.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_LOAD_FormerPosition.length == 0) {
   					commonByteArray_LOCAL_PROJECT_LOAD_FormerPosition = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_LOAD_FormerPosition = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_LOAD_FormerPosition, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_LOAD_FormerPosition, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_LOAD_FormerPosition) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_LOAD_FormerPosition_" + pid + "_tHashOutput_1";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_LOAD_FormerPosition_" + pid + "_tHashOutput_2";
 		                    ...
 		                    class SchemaSettingTool_tSalesforceInput_3_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"ExternalIdSplit__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ExternalIdSplit__c\",\"talend.field.dbColumnName\":\"ExternalIdSplit__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ExternalIdSplit__c\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"MAIN\",\"di.table.label\":\"Contact\"}",s);
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_3=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_3 = "tHashFile_LOAD_FormerPosition_" + pid + "_tHashOutput_3";
 		                    ...
 		                    class SchemaSettingTool_tSalesforceInput_1_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"ExternalIdSplit__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ExternalIdSplit__c\",\"talend.field.dbColumnName\":\"ExternalIdSplit__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ExternalIdSplit__c\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"MAIN\",\"di.table.label\":\"Account\"}",s);
 ...
 */
	...
	currentComponent="tHashOutput_3";
		...
		row2Struct oneRow_tHashOutput_3 = new row2Struct();
					...
					oneRow_tHashOutput_3.Id = row2.Id;
					oneRow_tHashOutput_3.ExternalIdSplit__c = row2.ExternalIdSplit__c;
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    ...
    static byte[] commonByteArray_LOCAL_PROJECT_LOAD_FormerPosition = new byte[0];
			    ...
			    public java.util.Date From__c;

				public java.util.Date getFrom__c () {
					return this.From__c;
				}
				...
				public String getJob_Title__c () {
					return this.Job_Title__c;
				}
				
			    public java.util.Date To__c;

				public java.util.Date getTo__c () {
					return this.To__c;
				}
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_LOAD_FormerPosition) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.Company__c = readString(dis);
					
					this.Contact__c = readString(dis);
					
					this.Comment__c = readString(dis);
					
					this.From__c = readDate(dis);
					
					this.Job_Title__c = readString(dis);
					
					this.To__c = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.Company__c,dos);
					
					// String
				
						writeString(this.Contact__c,dos);
					
					// String
				
						writeString(this.Comment__c,dos);
					
					// java.util.Date
				
						writeDate(this.From__c,dos);
					
					// String
				
						writeString(this.Job_Title__c,dos);
					
					// java.util.Date
				
						writeDate(this.To__c,dos);
    ...
    public String toString() {
		...
		sb.append(",Company__c="+Company__c);
		sb.append(",Contact__c="+Contact__c);
		sb.append(",Comment__c="+Comment__c);
		sb.append(",From__c="+String.valueOf(From__c));
		sb.append(",Job_Title__c="+Job_Title__c);
		sb.append(",To__c="+String.valueOf(To__c));
		sb.append(",ExternalIdSplit__c="+ExternalIdSplit__c);
...
public static class FormerPositionStruct implements routines.system.IPersistableRow<FormerPositionStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_LOAD_FormerPosition = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_LOAD_FormerPosition = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(FormerPositionStruct other) {
...
public static class after_tSalesforceInput_4Struct implements routines.system.IPersistableRow<after_tSalesforceInput_4Struct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_LOAD_FormerPosition = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_LOAD_FormerPosition = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(after_tSalesforceInput_4Struct other) {
...
FormerPositionStruct FormerPosition = new FormerPositionStruct();
	...
	currentComponent="tSalesforceOutputBulkExec_1_tSalesforceOutputBulk";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("FormerPosition" + iterateId, 0, 0);
 		                    ...
 		                    class SchemaSettingTool_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"Former_Position__c\",\"fields\":[{",s);
     		                    						...
     		                    						a("\"name\":\"Company__c\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Company__c\",\"talend.field.dbColumnName\":\"Company__c\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Company__c\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"Contact__c\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Contact__c\",\"talend.field.dbColumnName\":\"Contact__c\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Contact__c\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"Comment__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Comment__c\",\"talend.field.dbColumnName\":\"Comment__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Comment__c\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"From__c\",\"type\":[{\"type\":\"long\",\"java-class\":\"java.util.Date\"},\"null\"],\"di.table.comment\":\"\",\"di.prop.di.date.noLogicalType\":\"true\",\"AVRO_TECHNICAL_KEY\":\"From__c\",\"talend.field.dbColumnName\":\"From__c\",\"di.column.talendType\":\"id_Date\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"yyyy-MM-dd\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"From__c\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"Job_Title__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Job_Title__c\",\"talend.field.dbColumnName\":\"Job_Title__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"40\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Job_Title__c\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"To__c\",\"type\":[{\"type\":\"long\",\"java-class\":\"java.util.Date\"},\"null\"],\"di.table.comment\":\"\",\"di.prop.di.date.noLogicalType\":\"true\",\"AVRO_TECHNICAL_KEY\":\"To__c\",\"talend.field.dbColumnName\":\"To__c\",\"di.column.talendType\":\"id_Date\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"yyyy-MM-dd\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"To__c\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"ExternalIdSplit__c\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Id\",\"talend.field.dbColumnName\":\"ExternalIdSplit__c\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ExternalIdSplit__c\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"FormerPosition\",\"di.table.label\":\"Former_Position__c\"}",s);
...
ModifiedByStruct ModifiedByDefault = new ModifiedByStruct();
		...
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<ContactStruct> tHash_Lookup_Contact = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<ContactStruct>) 
				((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<ContactStruct>) 
					globalMap.get( "tHash_Lookup_Contact" ))
					;					
					
	

ContactStruct ContactHashKey = new ContactStruct();
ContactStruct ContactDefault = new ContactStruct();
	
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<AccountStruct> tHash_Lookup_Account = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<AccountStruct>) 
				((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<AccountStruct>) 
					globalMap.get( "tHash_Lookup_Account" ))
					;					
...
FormerPositionStruct FormerPosition_tmp = new FormerPositionStruct();
// ###############################
 		                    ...
 		                    class SchemaSettingTool_tSalesforceInput_4_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"To__c\",\"type\":[{\"type\":\"long\",\"java-class\":\"java.util.Date\"},\"null\"],\"di.table.comment\":\"\",\"di.prop.di.date.noLogicalType\":\"true\",\"AVRO_TECHNICAL_KEY\":\"To__c\",\"talend.field.dbColumnName\":\"To__c\",\"di.column.talendType\":\"id_Date\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"yyyy-MM-dd\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"To__c\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"MAIN\",\"di.table.label\":\"Former_Position__c\"}",s);
                ...
                Object columnValue_1_tSalesforceInput_4 = outgoingEnforcer_tSalesforceInput_4.get(1);
                    if (columnValue_1_tSalesforceInput_4 == null) {
                        row4.IsDeleted = false;
                            ...
                            row4.IsDeleted = (boolean) (columnValue_1_tSalesforceInput_4);
                    }
                Object columnValue_2_tSalesforceInput_4 = outgoingEnforcer_tSalesforceInput_4.get(2);
                        row4.Name = (String) (columnValue_2_tSalesforceInput_4);
                Object columnValue_3_tSalesforceInput_4 = outgoingEnforcer_tSalesforceInput_4.get(3);
                        row4.CurrencyIsoCode = (String) (columnValue_3_tSalesforceInput_4);
                Object columnValue_4_tSalesforceInput_4 = outgoingEnforcer_tSalesforceInput_4.get(4);
                        row4.CreatedDate = (java.util.Date) (columnValue_4_tSalesforceInput_4);
                Object columnValue_5_tSalesforceInput_4 = outgoingEnforcer_tSalesforceInput_4.get(5);
                        row4.CreatedById = (String) (columnValue_5_tSalesforceInput_4);
                Object columnValue_6_tSalesforceInput_4 = outgoingEnforcer_tSalesforceInput_4.get(6);
                        row4.LastModifiedDate = (java.util.Date) (columnValue_6_tSalesforceInput_4);
                Object columnValue_7_tSalesforceInput_4 = outgoingEnforcer_tSalesforceInput_4.get(7);
                        row4.LastModifiedById = (String) (columnValue_7_tSalesforceInput_4);
                Object columnValue_8_tSalesforceInput_4 = outgoingEnforcer_tSalesforceInput_4.get(8);
                        row4.SystemModstamp = (java.util.Date) (columnValue_8_tSalesforceInput_4);
                Object columnValue_9_tSalesforceInput_4 = outgoingEnforcer_tSalesforceInput_4.get(9);
                        row4.Contact__c = (String) (columnValue_9_tSalesforceInput_4);
                Object columnValue_10_tSalesforceInput_4 = outgoingEnforcer_tSalesforceInput_4.get(10);
                        row4.Company__c = (String) (columnValue_10_tSalesforceInput_4);
                Object columnValue_11_tSalesforceInput_4 = outgoingEnforcer_tSalesforceInput_4.get(11);
                        row4.Comment__c = (String) (columnValue_11_tSalesforceInput_4);
                Object columnValue_12_tSalesforceInput_4 = outgoingEnforcer_tSalesforceInput_4.get(12);
                        row4.From__c = (java.util.Date) (columnValue_12_tSalesforceInput_4);
                Object columnValue_13_tSalesforceInput_4 = outgoingEnforcer_tSalesforceInput_4.get(13);
                        row4.Job_Title__c = (String) (columnValue_13_tSalesforceInput_4);
                Object columnValue_14_tSalesforceInput_4 = outgoingEnforcer_tSalesforceInput_4.get(14);
                        row4.To__c = (java.util.Date) (columnValue_14_tSalesforceInput_4);
        ...
        // # Input tables (lookups)
		  ...
		  boolean mainRowRejected_tMap_1 = false;
 					    ...
 					    boolean forceLoopCreatedBy = false;
 							...
 							CreatedByStruct CreatedByObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		...
                        		    		CreatedByHashKey.ExternalIdSplit__c = row4.CreatedById ;
 					    ...
 					    boolean forceLoopModifiedBy = false;
 							...
 							ModifiedByStruct ModifiedByObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		...
                        		    		ModifiedByHashKey.ExternalIdSplit__c = row4.LastModifiedById ;
				...
				///////////////////////////////////////////////
 					    ...
 					    boolean forceLoopContact = false;
       		  	    	
       		  	    	
 							ContactStruct ContactObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		...
                        		    		ContactHashKey.ExternalIdSplit__c = row4.Contact__c ;
                        		    		

								
		                        	ContactHashKey.hashCodeDirty = true;
		  							...
		  							tHash_Lookup_Contact.lookup( ContactHashKey );
				           		...
				           		if(tHash_Lookup_Contact != null && tHash_Lookup_Contact.getCount(ContactHashKey) > 1) { // G 071
			  							
			  						
									 		
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'Contact' and it contains more one result from keys :  Contact.ExternalIdSplit__c = '" + ContactHashKey.ExternalIdSplit__c + "'");
								} // G 071
							...
							ContactStruct Contact = null;
	       		  	    	...
	       		  	    	ContactStruct fromLookup_Contact = null;
							Contact = ContactDefault;
								...
								if (tHash_Lookup_Contact !=null && tHash_Lookup_Contact.hasNext()) { // G 099
								
							
								
								fromLookup_Contact = tHash_Lookup_Contact.next();
							...
							if(fromLookup_Contact != null) {
								Contact = fromLookup_Contact;
							}
 					    ...
 					    boolean forceLoopAccount = false;
 							...
 							AccountStruct AccountObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		...
                        		    		AccountHashKey.ExternalIdSplit__c = row4.Company__c;
				           		...
				           		if(tHash_Lookup_Account != null && tHash_Lookup_Account.getCount(AccountHashKey) > 1) { // G 071
			  							
			  						
									 		
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'Account' and it contains more one result from keys :  Account.ExternalIdSplit__c = '" + AccountHashKey.ExternalIdSplit__c + "'");
								} // G 071
							...
							Account = AccountDefault;
								...
								if (tHash_Lookup_Account !=null && tHash_Lookup_Account.hasNext()) { // G 099
...
// # Output table : 'FormerPosition'
FormerPosition_tmp.CurrencyIsoCode = row4.CurrencyIsoCode;
FormerPosition_tmp.CreatedDate = row4.CreatedDate;
FormerPosition_tmp.CreatedById = CreatedBy.Id ;
FormerPosition_tmp.LastModifiedDate = row4.LastModifiedDate;
FormerPosition_tmp.LastModifiedById = ModifiedBy.Id ;
FormerPosition_tmp.Company__c = Account.Id ;
FormerPosition_tmp.Contact__c = Contact.Id ;
FormerPosition_tmp.Comment__c = row4.Comment__c;
FormerPosition_tmp.From__c = row4.From__c;
FormerPosition_tmp.Job_Title__c = row4.Job_Title__c;
FormerPosition_tmp.To__c = row4.To__c;
FormerPosition_tmp.ExternalIdSplit__c = row4.Id ;
FormerPosition = FormerPosition_tmp;
// ###############################
 ...
 */
// Start of branch "FormerPosition"
if(FormerPosition != null) { 
	...
	currentComponent="tSalesforceOutputBulkExec_1_tSalesforceOutputBulk";
			...
			//FormerPosition
				...
				if(execStat){
					runStat.updateStatOnConnection("FormerPosition"+iterateId,1, 1);
				} 
            ...
            incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.createNewRecord();
                    ...
                    if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.getRuntimeSchema().getField("CurrencyIsoCode") != null){
                        incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.put("CurrencyIsoCode", FormerPosition.CurrencyIsoCode);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.getRuntimeSchema().getField("CreatedDate") != null){
                        incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.put("CreatedDate", FormerPosition.CreatedDate);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.getRuntimeSchema().getField("CreatedById") != null){
                        incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.put("CreatedById", FormerPosition.CreatedById);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.getRuntimeSchema().getField("LastModifiedDate") != null){
                        incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.put("LastModifiedDate", FormerPosition.LastModifiedDate);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.getRuntimeSchema().getField("LastModifiedById") != null){
                        incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.put("LastModifiedById", FormerPosition.LastModifiedById);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.getRuntimeSchema().getField("Company__c") != null){
                        incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.put("Company__c", FormerPosition.Company__c);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.getRuntimeSchema().getField("Contact__c") != null){
                        incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.put("Contact__c", FormerPosition.Contact__c);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.getRuntimeSchema().getField("Comment__c") != null){
                        incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.put("Comment__c", FormerPosition.Comment__c);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.getRuntimeSchema().getField("From__c") != null){
                        incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.put("From__c", FormerPosition.From__c);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.getRuntimeSchema().getField("Job_Title__c") != null){
                        incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.put("Job_Title__c", FormerPosition.Job_Title__c);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.getRuntimeSchema().getField("To__c") != null){
                        incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.put("To__c", FormerPosition.To__c);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.getRuntimeSchema().getField("ExternalIdSplit__c") != null){
                        incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.put("ExternalIdSplit__c", FormerPosition.ExternalIdSplit__c);
                    }
 		                    props_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.setValue("bulkFilePath",
 		                    context.ProjetFolder+context.OutFileFolder+context.Output+TalendDate.getDate("CCYYMMDD")+jobName+"_bulk.csv");
...
// # Lookup hashes releasing
					...
					if(tHash_Lookup_Contact != null) {
						tHash_Lookup_Contact.endGet();
					}
					globalMap.remove( "tHash_Lookup_Contact" );
...
if(resultMap_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk!=null) {
	for(java.util.Map.Entry<String,Object> entry_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk : resultMap_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk.entrySet()) {
		...
		default :
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("FormerPosition"+iterateId,2, 0); 
			 	}
			}
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, false),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("LastModifiedById");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("Company__c");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("Contact__c");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("Comment__c");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("From__c");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("Job_Title__c");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("To__c");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_2, false),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_2.length()==0){
                                        ...
                                        outtFileOutputDelimited_2.write("LastModifiedById");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("Company__c");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("Contact__c");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("Comment__c");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("From__c");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("Job_Title__c");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("To__c");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
...
org.talend.components.salesforce.tsalesforcebulkexec.TSalesforceBulkExecProperties props_tSalesforceOutputBulkExec_1_tSalesforceBulkExec =
        (org.talend.components.salesforce.tsalesforcebulkexec.TSalesforceBulkExecProperties) def_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.createRuntimeProperties();
 		                    ...
 		                    props_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.setValue("upsertKeyColumn",
 		                    "ExternalIdSplit__c");
 		                    ...
 		                    class SchemaSettingTool_tSalesforceOutputBulkExec_1_tSalesforceBulkExec_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"salesforce_created\",\"type\":\"string\",\"talend.isLocked\":\"false\",\"talend.field.generated\":\"true\",\"talend.field.length\":\"255\"}],\"di.table.name\":\"FormerPosition\",\"di.table.label\":\"Former_Position__c\"}",s);
 		                    ...
 		                    class SchemaSettingTool_tSalesforceOutputBulkExec_1_tSalesforceBulkExec_2_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"error\",\"type\":\"string\",\"talend.isLocked\":\"false\",\"talend.field.generated\":\"true\",\"talend.field.length\":\"255\"}],\"di.table.name\":\"FormerPosition\",\"di.table.label\":\"Former_Position__c\"}",s);
    ...
    for (; available_tSalesforceOutputBulkExec_1_tSalesforceBulkExec; available_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = reader_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.advance()) {
        ...
        outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.setWrapped(factory_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.convertToAvro(data_tSalesforceOutputBulkExec_1_tSalesforceBulkExec));
                ...
                Object columnValue_1_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(1);
                        row5.CreatedDate = (java.util.Date) (columnValue_1_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_2_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(2);
                        row5.CreatedById = (String) (columnValue_2_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_3_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(3);
                        row5.LastModifiedDate = (java.util.Date) (columnValue_3_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_4_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(4);
                        row5.LastModifiedById = (String) (columnValue_4_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_5_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(5);
                        row5.Company__c = (String) (columnValue_5_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_6_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(6);
                        row5.Contact__c = (String) (columnValue_6_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_7_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(7);
                        row5.Comment__c = (String) (columnValue_7_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_8_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(8);
                        row5.From__c = (java.util.Date) (columnValue_8_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_9_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(9);
                        row5.Job_Title__c = (String) (columnValue_9_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_10_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(10);
                        row5.To__c = (java.util.Date) (columnValue_10_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_11_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(11);
                        row5.ExternalIdSplit__c = (String) (columnValue_11_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_12_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(12);
                        row5.salesforce_id = (String) (columnValue_12_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_13_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(13);
                        row5.salesforce_created = (String) (columnValue_13_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
        ...
        outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.setWrapped(factory_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.convertToAvro(data_tSalesforceOutputBulkExec_1_tSalesforceBulkExec));
                ...
                Object columnValue_1_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(1);
                        row6.CreatedDate = (java.util.Date) (columnValue_1_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_2_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(2);
                        row6.CreatedById = (String) (columnValue_2_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_3_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(3);
                        row6.LastModifiedDate = (java.util.Date) (columnValue_3_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_4_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(4);
                        row6.LastModifiedById = (String) (columnValue_4_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_5_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(5);
                        row6.Company__c = (String) (columnValue_5_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_6_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(6);
                        row6.Contact__c = (String) (columnValue_6_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_7_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(7);
                        row6.Comment__c = (String) (columnValue_7_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_8_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(8);
                        row6.From__c = (java.util.Date) (columnValue_8_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_9_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(9);
                        row6.Job_Title__c = (String) (columnValue_9_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_10_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(10);
                        row6.To__c = (java.util.Date) (columnValue_10_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                Object columnValue_11_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get(11);
                        row6.ExternalIdSplit__c = (String) (columnValue_11_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
                }catch(java.lang.Exception e){
                	// do nothing
                }
                        row6.error = (String)info_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.get("error");
            	// If the record is reject, the main line record should put NULL
            	row5 = null;
    }
			...
			//row5
				...
				if(execStat){
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(row5.LastModifiedDate, "yyyy-MM-dd'T'HH:mm:ss'.000Z'")
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row5.Company__c != null) {
                        sb_tFileOutputDelimited_1.append(
                            row5.Company__c
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row5.Contact__c != null) {
                        sb_tFileOutputDelimited_1.append(
                            row5.Contact__c
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row5.Comment__c != null) {
                        sb_tFileOutputDelimited_1.append(
                            row5.Comment__c
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row5.From__c != null) {
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(row5.From__c, "yyyy-MM-dd")
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row5.Job_Title__c != null) {
                        sb_tFileOutputDelimited_1.append(
                            row5.Job_Title__c
                        );
                            }
                            ...
                            if(row5.To__c != null) {
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(row5.To__c, "yyyy-MM-dd")
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row5.ExternalIdSplit__c != null) {
                        sb_tFileOutputDelimited_1.append(
                            row5.ExternalIdSplit__c
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
				...
				if(execStat){
                    ...
                    StringBuilder sb_tFileOutputDelimited_2 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_2.append(
                            row6.CurrencyIsoCode
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row6.CreatedDate != null) {
                        sb_tFileOutputDelimited_2.append(
                            FormatterUtils.format_Date(row6.CreatedDate, "yyyy-MM-dd'T'HH:mm:ss'.000Z'")
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                        ...
                        sb_tFileOutputDelimited_2.append(
                            FormatterUtils.format_Date(row6.LastModifiedDate, "yyyy-MM-dd'T'HH:mm:ss'.000Z'")
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row6.LastModifiedById != null) {
                        sb_tFileOutputDelimited_2.append(
                            row6.LastModifiedById
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row6.Company__c != null) {
                        sb_tFileOutputDelimited_2.append(
                            row6.Company__c
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row6.Contact__c != null) {
                        sb_tFileOutputDelimited_2.append(
                            row6.Contact__c
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row6.Comment__c != null) {
                        sb_tFileOutputDelimited_2.append(
                            row6.Comment__c
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row6.From__c != null) {
                        sb_tFileOutputDelimited_2.append(
                            FormatterUtils.format_Date(row6.From__c, "yyyy-MM-dd")
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row6.Job_Title__c != null) {
                        sb_tFileOutputDelimited_2.append(
                            row6.Job_Title__c
                        );
                            }
                            ...
                            if(row6.To__c != null) {
                        sb_tFileOutputDelimited_2.append(
                            FormatterUtils.format_Date(row6.To__c, "yyyy-MM-dd")
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row6.ExternalIdSplit__c != null) {
                        sb_tFileOutputDelimited_2.append(
                            row6.ExternalIdSplit__c
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row6.error != null) {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_CreatedBy";
		...
		int tos_count_tAdvancedHash_CreatedBy = 0;
			   		...
			   		// source node:tHashInput_2 - inputs:(after_tSalesforceInput_4) outputs:(CreatedBy,CreatedBy) | target node:tAdvancedHash_CreatedBy - inputs:(CreatedBy) outputs:()
			   		// linked node: tMap_1 - inputs:(row4,CreatedBy,ModifiedBy,Contact,Account) outputs:(FormerPosition)
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row1Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_LOAD_FormerPosition_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_LOAD_FormerPosition_" + pid +"_tHashOutput_1");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_ModifiedBy";
		...
		int tos_count_tAdvancedHash_ModifiedBy = 0;
			   		...
			   		// source node:tHashInput_3 - inputs:(after_tSalesforceInput_4) outputs:(ModifiedBy,ModifiedBy) | target node:tAdvancedHash_ModifiedBy - inputs:(ModifiedBy) outputs:()
			   		// linked node: tMap_1 - inputs:(row4,CreatedBy,ModifiedBy,Contact,Account) outputs:(FormerPosition)
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row1Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_LOAD_FormerPosition_" + pid +"_tHashOutput_1");
...
public static class ContactStruct implements routines.system.IPersistableComparableLookupRow<ContactStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_LOAD_FormerPosition = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_LOAD_FormerPosition = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final ContactStruct other = (ContactStruct) obj;
	...
	public void copyDataTo(ContactStruct other) {
	...
	public void copyKeysDataTo(ContactStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(ContactStruct other) {
...
public void tHashInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	/**
	 * [tAdvancedHash_Contact begin ] start
	 */
		...
		ok_Hash.put("tAdvancedHash_Contact", false);
		start_Hash.put("tAdvancedHash_Contact", System.currentTimeMillis());
		
	
	currentComponent="tAdvancedHash_Contact";

	
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
					
						runStat.updateStatOnConnection("Contact" + iterateId, 0, 0);
					
				}
			} 

		
		int tos_count_tAdvancedHash_Contact = 0;
		

			   		// connection name:Contact
			   		// source node:tHashInput_4 - inputs:(after_tSalesforceInput_4) outputs:(Contact,Contact) | target node:tAdvancedHash_Contact - inputs:(Contact) outputs:()
			   		// linked node: tMap_1 - inputs:(row4,CreatedBy,ModifiedBy,Contact,Account) outputs:(FormerPosition)
			   
			   		org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_Contact = 
			   			org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
			   			
			   
	   			org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<ContactStruct> tHash_Lookup_Contact =org.talend.designer.components.lookup.memory.AdvancedMemoryLookup.
	   						<ContactStruct>getLookup(matchingModeEnum_Contact);
	   						   
		   	   	   globalMap.put("tHash_Lookup_Contact", tHash_Lookup_Contact);
...
/**
 * [tAdvancedHash_Contact begin ] stop
 */
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_4 = mf_tHashInput_4.getAdvancedMemoryHashFile("tHashFile_LOAD_FormerPosition_" + pid +"_tHashOutput_2");
...
while (iterator_tHashInput_4.hasNext()) {
	...
	Contact.Id = next_tHashInput_4.Id;
	Contact.ExternalIdSplit__c = next_tHashInput_4.ExternalIdSplit__c;
 ...
 */
	...
	/**
	 * [tAdvancedHash_Contact main ] start
	 */
	...
	currentComponent="tAdvancedHash_Contact";
			...
			//Contact
				...
				if(execStat){
					runStat.updateStatOnConnection("Contact"+iterateId,1, 1);
				} 
					...
					ContactStruct Contact_HashRow = new ContactStruct();
		   	   	   
				
				Contact_HashRow.Id = Contact.Id;
				
				Contact_HashRow.ExternalIdSplit__c = Contact.ExternalIdSplit__c;
				
			tHash_Lookup_Contact.put(Contact_HashRow);
	...
	tos_count_tAdvancedHash_Contact++;

/**
 * [tAdvancedHash_Contact main ] stop
 */
	
	/**
	 * [tAdvancedHash_Contact process_data_begin ] start
	 */
...
/**
 * [tAdvancedHash_Contact process_data_begin ] stop
 */
	
	/**
	 * [tAdvancedHash_Contact process_data_end ] start
	 */
...
/**
 * [tAdvancedHash_Contact process_data_end ] stop
 */
 ...
 */
	...
	currentComponent="tHashInput_4";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_LOAD_FormerPosition_" + pid +"_tHashOutput_2");
 ...
 */
	...
	/**
	 * [tAdvancedHash_Contact end ] start
	 */
...
tHash_Lookup_Contact.endPut();

			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("Contact"+iterateId,2, 0); 
			 	}
			}
		
 

ok_Hash.put("tAdvancedHash_Contact", true);
end_Hash.put("tAdvancedHash_Contact", System.currentTimeMillis());




/**
 * [tAdvancedHash_Contact end ] stop
 */
 ...
 */
	...
	/**
	 * [tAdvancedHash_Contact finally ] start
	 */
...
/**
 * [tAdvancedHash_Contact finally ] stop
 */
...
public static class AccountStruct implements routines.system.IPersistableComparableLookupRow<AccountStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_LOAD_FormerPosition = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_LOAD_FormerPosition = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
...
public void tHashInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		start_Hash.put("tAdvancedHash_Account", System.currentTimeMillis());
	...
	currentComponent="tAdvancedHash_Account";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("Account" + iterateId, 0, 0);
		...
		int tos_count_tAdvancedHash_Account = 0;
			   		...
			   		// source node:tHashInput_1 - inputs:(after_tSalesforceInput_4) outputs:(Account,Account) | target node:tAdvancedHash_Account - inputs:(Account) outputs:()
			   		// linked node: tMap_1 - inputs:(row4,CreatedBy,ModifiedBy,Contact,Account) outputs:(FormerPosition)
			   
			   		org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_Account = 
			   			org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row2Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_LOAD_FormerPosition_" + pid +"_tHashOutput_3");
...
while (iterator_tHashInput_1.hasNext()) {
	...
	Account.Id = next_tHashInput_1.Id;
	Account.ExternalIdSplit__c = next_tHashInput_1.ExternalIdSplit__c;
 ...
 */
	...
	currentComponent="tAdvancedHash_Account";
			...
			//Account
				...
				if(execStat){
					runStat.updateStatOnConnection("Account"+iterateId,1, 1);
				} 
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_LOAD_FormerPosition_" + pid +"_tHashOutput_3");
...
tHash_Lookup_Account.endPut();
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("Account"+iterateId,2, 0); 
			 	}
			}
...
end_Hash.put("tAdvancedHash_Account", System.currentTimeMillis());
 ...
 */
    ...
    public static void main(String[] args){
        final LOAD_FormerPosition LOAD_FormerPositionClass = new LOAD_FormerPosition();

        int exitCode = LOAD_FormerPositionClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = LOAD_FormerPosition.class.getClassLoader().getResourceAsStream("local_project/load_formerposition_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = LOAD_FormerPosition.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LOAD_FormerPosition");
        }
...
/************************************************************************************************
 *     474342 characters generated by Talend Open Studio for Data Integration 
 *     on the 7 novembre 2019 17:53:24 CET
 ************************************************************************************************/