...
package local_project.load_gooddescription_0_1;
...
/**
 * Job: LOAD_GoodDescription Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class LOAD_GoodDescription implements TalendJob {
	...
	private final String jobName = "LOAD_GoodDescription";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					LOAD_GoodDescription.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(LOAD_GoodDescription.this, new Object[] {
	...
	public void tAdvancedHash_RecordTypePreprod_error(Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public static class row_Implicit_Context_RegexStruct implements
		...
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_LOAD_GoodDescription = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_LOAD_GoodDescription = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_LOAD_GoodDescription.length) {
					if (length < 1024
							&& commonByteArray_LOCAL_PROJECT_LOAD_GoodDescription.length == 0) {
						commonByteArray_LOCAL_PROJECT_LOAD_GoodDescription = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_LOAD_GoodDescription = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_LOCAL_PROJECT_LOAD_GoodDescription, 0,
						length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_LOAD_GoodDescription) {
	...
	public void tSalesforceInput_2Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String hashKey_tHashOutput_1 = "tHashFile_LOAD_GoodDescription_"
						+ pid + "_tHashOutput_1";
	...
	public void tSalesforceInput_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String hashKey_tHashOutput_2 = "tHashFile_LOAD_GoodDescription_"
						+ pid + "_tHashOutput_2";
				synchronized (org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap
	...
	public void tSalesforceInput_3Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String hashKey_tHashOutput_4 = "tHashFile_LOAD_GoodDescription_"
						+ pid + "_tHashOutput_4";
				synchronized (org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap
				...
				props_tSalesforceInput_3.setValue("condition",
						"SobjectType='Goods_description__c'");
				...
				for (; available_tSalesforceInput_3; available_tSalesforceInput_3 = reader_tSalesforceInput_3
					...
					try {
						...
						Object columnValue_0_tSalesforceInput_3 = outgoingEnforcer_tSalesforceInput_3
								.get(0);
						row7.Id = (String) (columnValue_0_tSalesforceInput_3);
						Object columnValue_1_tSalesforceInput_3 = outgoingEnforcer_tSalesforceInput_3
								.get(1);
						row7.DeveloperName = (String) (columnValue_1_tSalesforceInput_3);
					...
					oneRow_tHashOutput_4.Id = row7.Id;
					oneRow_tHashOutput_4.DeveloperName = row7.DeveloperName;
	...
	public void tSalesforceInput_4Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String hashKey_tHashOutput_5 = "tHashFile_LOAD_GoodDescription_"
						+ pid + "_tHashOutput_5";
				synchronized (org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap
				...
				for (; available_tSalesforceInput_4; available_tSalesforceInput_4 = reader_tSalesforceInput_4
					...
					try {
						...
						Object columnValue_1_tSalesforceInput_4 = outgoingEnforcer_tSalesforceInput_4
								.get(1);
						row8.DeveloperName = (String) (columnValue_1_tSalesforceInput_4);
					...
					oneRow_tHashOutput_5.DeveloperName = row8.DeveloperName;
	...
	public static class row5Struct implements
		...
		public String Opportunity_Goods__c;

		public String getOpportunity_Goods__c() {
			return this.Opportunity_Goods__c;
		}

		public String Diameter__c;

		public String getDiameter__c() {
			return this.Diameter__c;
		}

		public String ERS__c;

		public String getERS__c() {
			return this.ERS__c;
		}

		public String Exposure__c;

		public String getExposure__c() {
			return this.Exposure__c;
		}

		public String Installed_On__c;

		public String getInstalled_On__c() {
			return this.Installed_On__c;
		}

		public String Layer__c;

		public String getLayer__c() {
			return this.Layer__c;
		}

		public String OP_Type__c;

		public String getOP_Type__c() {
			return this.OP_Type__c;
		}
		...
		public String getQC__c() {
			return this.QC__c;
		}

		public Double QTY__c;

		public Double getQTY__c() {
			return this.QTY__c;
		}

		public String Revision_Number__c;

		public String getRevision_Number__c() {
			return this.Revision_Number__c;
		}

		public String Row_Material__c;

		public String getRow_Material__c() {
			return this.Row_Material__c;
		}

		public String Scope__c;

		public String getScope__c() {
			return this.Scope__c;
		}

		public String Supply__c;

		public String getSupply__c() {
			return this.Supply__c;
		}

		public String System__c;

		public String getSystem__c() {
			return this.System__c;
		}

		public String Type_Arm__c;

		public String getType_Arm__c() {
			return this.Type_Arm__c;
		}
		...
		public String VRL__c;

		public String getVRL__c() {
			return this.VRL__c;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_LOAD_GoodDescription) {
				...
				try {
					...
					this.Opportunity_Goods__c = readString(dis);

					this.Diameter__c = readString(dis);

					this.ERS__c = readString(dis);

					this.Exposure__c = readString(dis);

					this.Installed_On__c = readString(dis);

					this.Layer__c = readString(dis);

					this.OP_Type__c = readString(dis);

					this.Product__c = readString(dis);

					this.QC__c = readString(dis);

					length = dis.readByte();
					if (length == -1) {
						this.QTY__c = null;
					} else {
						this.QTY__c = dis.readDouble();
					}

					this.Revision_Number__c = readString(dis);

					this.Row_Material__c = readString(dis);

					this.Scope__c = readString(dis);

					this.Supply__c = readString(dis);

					this.System__c = readString(dis);

					this.Type_Arm__c = readString(dis);

					this.Type__c = readString(dis);

					this.VRL__c = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.Opportunity_Goods__c, dos);

				// String

				writeString(this.Diameter__c, dos);

				// String

				writeString(this.ERS__c, dos);

				// String

				writeString(this.Exposure__c, dos);

				// String

				writeString(this.Installed_On__c, dos);

				// String

				writeString(this.Layer__c, dos);

				// String

				writeString(this.OP_Type__c, dos);

				// String

				writeString(this.Product__c, dos);

				// String

				writeString(this.QC__c, dos);
				...
				if (this.QTY__c == null) {
					...
					dos.writeByte(0);
					dos.writeDouble(this.QTY__c);
				}

				// String

				writeString(this.Revision_Number__c, dos);

				// String

				writeString(this.Row_Material__c, dos);

				// String

				writeString(this.Scope__c, dos);

				// String

				writeString(this.Supply__c, dos);

				// String

				writeString(this.System__c, dos);

				// String

				writeString(this.Type_Arm__c, dos);
		...
		public String toString() {
			...
			sb.append(",Opportunity_Goods__c=" + Opportunity_Goods__c);
			sb.append(",Diameter__c=" + Diameter__c);
			sb.append(",ERS__c=" + ERS__c);
			sb.append(",Exposure__c=" + Exposure__c);
			sb.append(",Installed_On__c=" + Installed_On__c);
			sb.append(",Layer__c=" + Layer__c);
			sb.append(",OP_Type__c=" + OP_Type__c);
			sb.append(",Product__c=" + Product__c);
			sb.append(",QC__c=" + QC__c);
			sb.append(",QTY__c=" + String.valueOf(QTY__c));
			sb.append(",Revision_Number__c=" + Revision_Number__c);
			sb.append(",Row_Material__c=" + Row_Material__c);
			sb.append(",Scope__c=" + Scope__c);
			sb.append(",Supply__c=" + Supply__c);
			sb.append(",System__c=" + System__c);
			sb.append(",Type_Arm__c=" + Type_Arm__c);
			sb.append(",Type__c=" + Type__c);
			sb.append(",VRL__c=" + VRL__c);
			sb.append(",ExternalIdSplit__c=" + ExternalIdSplit__c);
	...
	public static class GoodDescriptionStruct implements
			routines.system.IPersistableRow<GoodDescriptionStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_LOAD_GoodDescription = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_LOAD_GoodDescription = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(GoodDescriptionStruct other) {
	...
	public static class Goods_descriptionStruct implements
			routines.system.IPersistableRow<Goods_descriptionStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_LOAD_GoodDescription = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_LOAD_GoodDescription = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(Goods_descriptionStruct other) {
	...
	public static class after_tSalesforceInput_5Struct implements
			routines.system.IPersistableRow<after_tSalesforceInput_5Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_LOAD_GoodDescription = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_LOAD_GoodDescription = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(after_tSalesforceInput_5Struct other) {
	...
	public void tSalesforceInput_5Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				Goods_descriptionStruct Goods_description = new Goods_descriptionStruct();
				GoodDescriptionStruct GoodDescription = new GoodDescriptionStruct();
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						runStat.updateStatOnConnection("GoodDescription"
								+ iterateId, 0, 0);
				...
				class SchemaSettingTool_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk_1_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"Goods_description__c\",\"fields\":[{", s);
						...
						a("\"name\":\"Opportunity_Goods__c\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Opportunity_Goods__c\",\"talend.field.dbColumnName\":\"Opportunity_Goods__c\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Opportunity_Goods__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Diameter__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Diameter__c\",\"talend.field.dbColumnName\":\"Diameter__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Diameter__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"ERS__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ERS__c\",\"talend.field.dbColumnName\":\"ERS__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ERS__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Exposure__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Exposure__c\",\"talend.field.dbColumnName\":\"Exposure__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Exposure__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Installed_On__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Installed_On__c\",\"talend.field.dbColumnName\":\"Installed_On__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Installed_On__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Layer__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Layer__c\",\"talend.field.dbColumnName\":\"Layer__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Layer__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"OP_Type__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"OP_Type__c\",\"talend.field.dbColumnName\":\"OP_Type__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"OP_Type__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Product__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Product__c\",\"talend.field.dbColumnName\":\"Product__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Product__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"QC__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"QC__c\",\"talend.field.dbColumnName\":\"QC__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"QC__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"QTY__c\",\"type\":[\"double\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"QTY__c\",\"talend.field.dbColumnName\":\"QTY__c\",\"di.column.talendType\":\"id_Double\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"10\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"QTY__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Revision_Number__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Revision_Number__c\",\"talend.field.dbColumnName\":\"Revision_Number__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Revision_Number__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Row_Material__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Row_Material__c\",\"talend.field.dbColumnName\":\"Row_Material__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Row_Material__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Scope__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Scope__c\",\"talend.field.dbColumnName\":\"Scope__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Scope__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Supply__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Supply__c\",\"talend.field.dbColumnName\":\"Supply__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Supply__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"System__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"System__c\",\"talend.field.dbColumnName\":\"System__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"System__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Type_Arm__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Type_Arm__c\",\"talend.field.dbColumnName\":\"Type_Arm__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Type_Arm__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"Type__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Type__c\",\"talend.field.dbColumnName\":\"Type__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Type__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"VRL__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"VRL__c\",\"talend.field.dbColumnName\":\"VRL__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"VRL__c\",\"di.column.relatedEntity\":\"\"},{",
								s);

						a("\"name\":\"ExternalIdSplit__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ExternalIdSplit__c\",\"talend.field.dbColumnName\":\"ExternalIdSplit__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ExternalIdSplit__c\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"GoodDescription\",\"di.table.label\":\"Goods_description__c\"}",
								s);
				...
				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {
						...
						runStat.updateStatOnConnection("Goods_description"
								+ iterateId, 0, 0);
				...
				// ###############################
				// # Outputs initialization
				GoodDescriptionStruct GoodDescription_tmp = new GoodDescriptionStruct();
				// ###############################
				...
				org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<RecordTypePreprodStruct> tHash_Lookup_RecordTypePreprod = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<RecordTypePreprodStruct>) ((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<RecordTypePreprodStruct>) globalMap
						.get("tHash_Lookup_RecordTypePreprod"));

				RecordTypePreprodStruct RecordTypePreprodHashKey = new RecordTypePreprodStruct();
				RecordTypePreprodStruct RecordTypePreprodDefault = new RecordTypePreprodStruct();
				// ###############################
				...
				// ###############################
				// # Outputs initialization
				Goods_descriptionStruct Goods_description_tmp = new Goods_descriptionStruct();
				// ###############################
				...
				class SchemaSettingTool_tSalesforceInput_5_1_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"Supply__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Supply__c\",\"talend.field.dbColumnName\":\"Supply__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Supply__c\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"MAIN\",\"di.table.label\":\"Goods_description__c\"}",
								s);
				...
				for (; available_tSalesforceInput_5; available_tSalesforceInput_5 = reader_tSalesforceInput_5
					...
					try {
						...
						Object columnValue_0_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(0);
						row3.Id = (String) (columnValue_0_tSalesforceInput_5);
						...
						if (columnValue_1_tSalesforceInput_5 == null) {
							...
							row3.IsDeleted = (boolean) (columnValue_1_tSalesforceInput_5);
						}
						Object columnValue_2_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(2);
						row3.Name = (String) (columnValue_2_tSalesforceInput_5);
						Object columnValue_3_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(3);
						row3.CurrencyIsoCode = (String) (columnValue_3_tSalesforceInput_5);
						Object columnValue_4_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(4);
						row3.RecordTypeId = (String) (columnValue_4_tSalesforceInput_5);
						Object columnValue_5_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(5);
						row3.CreatedDate = (java.util.Date) (columnValue_5_tSalesforceInput_5);
						Object columnValue_6_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(6);
						row3.CreatedById = (String) (columnValue_6_tSalesforceInput_5);
						Object columnValue_7_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(7);
						row3.LastModifiedDate = (java.util.Date) (columnValue_7_tSalesforceInput_5);
						Object columnValue_8_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(8);
						row3.LastModifiedById = (String) (columnValue_8_tSalesforceInput_5);
						Object columnValue_9_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(9);
						row3.SystemModstamp = (java.util.Date) (columnValue_9_tSalesforceInput_5);
						Object columnValue_10_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(10);
						row3.LastActivityDate = (java.util.Date) (columnValue_10_tSalesforceInput_5);
						Object columnValue_11_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(11);
						row3.LastViewedDate = (java.util.Date) (columnValue_11_tSalesforceInput_5);
						Object columnValue_12_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(12);
						row3.LastReferencedDate = (java.util.Date) (columnValue_12_tSalesforceInput_5);
						Object columnValue_13_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(13);
						row3.Opportunity_Goods__c = (String) (columnValue_13_tSalesforceInput_5);
						Object columnValue_14_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(14);
						row3.Diameter__c = (String) (columnValue_14_tSalesforceInput_5);
						Object columnValue_15_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(15);
						row3.ERS__c = (String) (columnValue_15_tSalesforceInput_5);
						Object columnValue_16_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(16);
						row3.Exposure__c = (String) (columnValue_16_tSalesforceInput_5);
						Object columnValue_17_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(17);
						row3.Installed_On__c = (String) (columnValue_17_tSalesforceInput_5);
						Object columnValue_18_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(18);
						row3.Layer__c = (String) (columnValue_18_tSalesforceInput_5);
						Object columnValue_19_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(19);
						row3.OP_Type__c = (String) (columnValue_19_tSalesforceInput_5);
						Object columnValue_20_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(20);
						row3.Product__c = (String) (columnValue_20_tSalesforceInput_5);
						Object columnValue_21_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(21);
						row3.QC__c = (String) (columnValue_21_tSalesforceInput_5);
						Object columnValue_22_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(22);
						row3.QTY__c = (Double) (columnValue_22_tSalesforceInput_5);
						Object columnValue_23_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(23);
						row3.Revision_Number__c = (String) (columnValue_23_tSalesforceInput_5);
						Object columnValue_24_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(24);
						row3.Row_Material__c = (String) (columnValue_24_tSalesforceInput_5);
						Object columnValue_25_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(25);
						row3.Scope__c = (String) (columnValue_25_tSalesforceInput_5);
						Object columnValue_26_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(26);
						row3.System__c = (String) (columnValue_26_tSalesforceInput_5);
						Object columnValue_27_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(27);
						row3.Type_Arm__c = (String) (columnValue_27_tSalesforceInput_5);
						Object columnValue_28_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(28);
						row3.Type__c = (String) (columnValue_28_tSalesforceInput_5);
						Object columnValue_29_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(29);
						row3.VRL__c = (String) (columnValue_29_tSalesforceInput_5);
						Object columnValue_30_tSalesforceInput_5 = outgoingEnforcer_tSalesforceInput_5
								.get(30);
						row3.Supply__c = (String) (columnValue_30_tSalesforceInput_5);
					...
					if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
						...
						OpportunityHashKey.ExternalIdSplit__c = row3.Opportunity_Goods__c;
					...
					if (tHash_Lookup_Opportunity != null
							&& tHash_Lookup_Opportunity.hasNext()) { // G 099
					...
					// /////////////////////////////////////////////
					// Starting Lookup Table "RecordTypePreprod"
					// /////////////////////////////////////////////

					boolean forceLoopRecordTypePreprod = false;

					RecordTypePreprodStruct RecordTypePreprodObjectFromLookup = null;

					if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020

						hasCasePrimitiveKeyWithNull_tMap_1 = false;

						RecordTypePreprodHashKey.Id = row3.RecordTypeId;

						RecordTypePreprodHashKey.hashCodeDirty = true;

						tHash_Lookup_RecordTypePreprod
								.lookup(RecordTypePreprodHashKey);

					} // G_TM_M_020

					if (tHash_Lookup_RecordTypePreprod != null
							&& tHash_Lookup_RecordTypePreprod
									.getCount(RecordTypePreprodHashKey) > 1) { // G
																				// 071

						// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'RecordTypePreprod' and it contains more one result from keys :  RecordTypePreprod.Id = '"
						// + RecordTypePreprodHashKey.Id + "'");
					} // G 071

					RecordTypePreprodStruct RecordTypePreprod = null;

					RecordTypePreprodStruct fromLookup_RecordTypePreprod = null;
					RecordTypePreprod = RecordTypePreprodDefault;

					if (tHash_Lookup_RecordTypePreprod != null
							&& tHash_Lookup_RecordTypePreprod.hasNext()) { // G
																			// 099

						fromLookup_RecordTypePreprod = tHash_Lookup_RecordTypePreprod
								.next();

					} // G 099

					if (fromLookup_RecordTypePreprod != null) {
						RecordTypePreprod = fromLookup_RecordTypePreprod;
					}
					...
					{ // start of Var scope
						...
						// # Output table : 'Goods_description'
						Goods_description_tmp.CurrencyIsoCode = row3.CurrencyIsoCode;
						Goods_description_tmp.RecordTypeId = RecordTypePreprod.DeveloperName;
						Goods_description_tmp.CreatedDate = row3.CreatedDate;
						Goods_description_tmp.CreatedById = CreatedBy.Id;
						Goods_description_tmp.LastModifiedDate = row3.LastModifiedDate;
						Goods_description_tmp.LastModifiedById = ModifiedBy.Id;
						Goods_description_tmp.Opportunity_Goods__c = Opportunity.Id;
						Goods_description_tmp.Diameter__c = row3.Diameter__c;
						Goods_description_tmp.ERS__c = row3.ERS__c;
						Goods_description_tmp.Exposure__c = row3.Exposure__c;
						Goods_description_tmp.Installed_On__c = row3.Installed_On__c;
						Goods_description_tmp.Layer__c = row3.Layer__c;
						Goods_description_tmp.OP_Type__c = row3.OP_Type__c;
						Goods_description_tmp.Product__c = row3.Product__c;
						Goods_description_tmp.QC__c = row3.QC__c;
						Goods_description_tmp.QTY__c = row3.QTY__c;
						Goods_description_tmp.Revision_Number__c = row3.Revision_Number__c;
						Goods_description_tmp.Row_Material__c = row3.Row_Material__c;
						Goods_description_tmp.Scope__c = row3.Scope__c;
						Goods_description_tmp.Supply__c = row3.Supply__c;
						Goods_description_tmp.System__c = row3.System__c;
						Goods_description_tmp.Type_Arm__c = row3.Type_Arm__c;
						Goods_description_tmp.Type__c = row3.Type__c;
						Goods_description_tmp.VRL__c = row3.VRL__c;
						Goods_description_tmp.ExternalIdSplit__c = row3.Id;
						Goods_description = Goods_description_tmp;
						// ###############################
					 ...
					 */
					// Start of branch "Goods_description"
					if (Goods_description != null) {
						...
						if (!rejectedInnerJoin_tMap_3) { // G_TM_M_020
							...
							row4HashKey.DeveloperName = Goods_description.RecordTypeId;
						...
						if (tHash_Lookup_row4 != null
							...
							// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row4' and it contains more one result from keys :  row4.DeveloperName = '"
							// + row4HashKey.DeveloperName + "'");
						} // G 071
						...
						{ // start of Var scope
							...
							// # Output table : 'GoodDescription'
							GoodDescription_tmp.CurrencyIsoCode = Goods_description.CurrencyIsoCode;
							GoodDescription_tmp.RecordTypeId = row4.Id;
							GoodDescription_tmp.CreatedDate = Goods_description.CreatedDate;
							GoodDescription_tmp.CreatedById = Goods_description.CreatedById;
							GoodDescription_tmp.LastModifiedDate = Goods_description.LastModifiedDate;
							GoodDescription_tmp.LastModifiedById = Goods_description.LastModifiedById;
							GoodDescription_tmp.Opportunity_Goods__c = Goods_description.Opportunity_Goods__c;
							GoodDescription_tmp.Diameter__c = Goods_description.Diameter__c;
							GoodDescription_tmp.ERS__c = Goods_description.ERS__c;
							GoodDescription_tmp.Exposure__c = Goods_description.Exposure__c;
							GoodDescription_tmp.Installed_On__c = Goods_description.Installed_On__c;
							GoodDescription_tmp.Layer__c = Goods_description.Layer__c;
							GoodDescription_tmp.OP_Type__c = Goods_description.OP_Type__c;
							GoodDescription_tmp.Product__c = Goods_description.Product__c;
							GoodDescription_tmp.QC__c = Goods_description.QC__c;
							GoodDescription_tmp.QTY__c = Goods_description.QTY__c;
							GoodDescription_tmp.Revision_Number__c = Goods_description.Revision_Number__c;
							GoodDescription_tmp.Row_Material__c = Goods_description.Row_Material__c;
							GoodDescription_tmp.Scope__c = Goods_description.Scope__c;
							GoodDescription_tmp.Supply__c = Goods_description.Supply__c;
							GoodDescription_tmp.System__c = Goods_description.System__c;
							GoodDescription_tmp.Type_Arm__c = Goods_description.Type_Arm__c;
							GoodDescription_tmp.Type__c = Goods_description.Type__c;
							GoodDescription_tmp.VRL__c = Goods_description.VRL__c;
							GoodDescription_tmp.ExternalIdSplit__c = Goods_description.ExternalIdSplit__c;
							GoodDescription = GoodDescription_tmp;
							// ###############################
						 ...
						 */
						// Start of branch "GoodDescription"
						if (GoodDescription != null) {
							...
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
								...
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("CurrencyIsoCode",
												GoodDescription.CurrencyIsoCode);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
							...
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
								...
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("LastModifiedDate",
												GoodDescription.LastModifiedDate);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
								...
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("LastModifiedById",
												GoodDescription.LastModifiedById);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
									.getRuntimeSchema().getField(
											"Opportunity_Goods__c") != null) {
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("Opportunity_Goods__c",
												GoodDescription.Opportunity_Goods__c);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
									.getRuntimeSchema().getField("Diameter__c") != null) {
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("Diameter__c",
												GoodDescription.Diameter__c);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
									.getRuntimeSchema().getField("ERS__c") != null) {
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("ERS__c", GoodDescription.ERS__c);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
									.getRuntimeSchema().getField("Exposure__c") != null) {
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("Exposure__c",
												GoodDescription.Exposure__c);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
									.getRuntimeSchema().getField(
											"Installed_On__c") != null) {
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("Installed_On__c",
												GoodDescription.Installed_On__c);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
									.getRuntimeSchema().getField("Layer__c") != null) {
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("Layer__c",
												GoodDescription.Layer__c);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
									.getRuntimeSchema().getField("OP_Type__c") != null) {
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("OP_Type__c",
												GoodDescription.OP_Type__c);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
									.getRuntimeSchema().getField("Product__c") != null) {
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("Product__c",
												GoodDescription.Product__c);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
									.getRuntimeSchema().getField("QC__c") != null) {
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("QC__c", GoodDescription.QC__c);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
									.getRuntimeSchema().getField("QTY__c") != null) {
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("QTY__c", GoodDescription.QTY__c);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
									.getRuntimeSchema().getField(
											"Revision_Number__c") != null) {
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("Revision_Number__c",
												GoodDescription.Revision_Number__c);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
									.getRuntimeSchema().getField(
											"Row_Material__c") != null) {
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("Row_Material__c",
												GoodDescription.Row_Material__c);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
									.getRuntimeSchema().getField("Scope__c") != null) {
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("Scope__c",
												GoodDescription.Scope__c);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
									.getRuntimeSchema().getField("Supply__c") != null) {
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("Supply__c",
												GoodDescription.Supply__c);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
									.getRuntimeSchema().getField("System__c") != null) {
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("System__c",
												GoodDescription.System__c);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
									.getRuntimeSchema().getField("Type_Arm__c") != null) {
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("Type_Arm__c",
												GoodDescription.Type_Arm__c);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
									.getRuntimeSchema().getField("Type__c") != null) {
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("Type__c", GoodDescription.Type__c);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
									.getRuntimeSchema().getField("VRL__c") != null) {
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("VRL__c", GoodDescription.VRL__c);
							}
							// skip the put action if the input column doesn't
							// appear in component runtime schema
							if (incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
								...
								incomingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
										.put("ExternalIdSplit__c",
												GoodDescription.ExternalIdSplit__c);
							}
							props_tSalesforceOutputBulkExec_1_tSalesforceOutputBulk
									.setValue(
											"bulkFilePath",
					...
					} // End of branch "Goods_description"
				...
				if (tHash_Lookup_RecordTypePreprod != null) {
					tHash_Lookup_RecordTypePreprod.endGet();
				}
				globalMap.remove("tHash_Lookup_RecordTypePreprod");
				...
				if (filetFileOutputDelimited_1.length() == 0) {
					...
					outtFileOutputDelimited_1
							.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("Opportunity_Goods__c");
					outtFileOutputDelimited_1
							.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("Diameter__c");
					outtFileOutputDelimited_1
							.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("ERS__c");
					outtFileOutputDelimited_1
							.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("Exposure__c");
					outtFileOutputDelimited_1
							.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("Installed_On__c");
					outtFileOutputDelimited_1
							.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("Layer__c");
					outtFileOutputDelimited_1
							.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("OP_Type__c");
					outtFileOutputDelimited_1
							.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("Product__c");
					outtFileOutputDelimited_1
							.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("QC__c");
					outtFileOutputDelimited_1
							.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("QTY__c");
					outtFileOutputDelimited_1
							.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("Revision_Number__c");
					outtFileOutputDelimited_1
							.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("Row_Material__c");
					outtFileOutputDelimited_1
							.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("Scope__c");
					outtFileOutputDelimited_1
							.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("Supply__c");
					outtFileOutputDelimited_1
							.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("System__c");
					outtFileOutputDelimited_1
							.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("Type_Arm__c");
					outtFileOutputDelimited_1
							.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("Type__c");
					outtFileOutputDelimited_1
							.write(OUT_DELIM_tFileOutputDelimited_1);
					outtFileOutputDelimited_1.write("VRL__c");
					outtFileOutputDelimited_1
							.write(OUT_DELIM_tFileOutputDelimited_1);
				...
				if (filetFileOutputDelimited_2.length() == 0) {
					...
					outtFileOutputDelimited_2
							.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("Opportunity_Goods__c");
					outtFileOutputDelimited_2
							.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("Diameter__c");
					outtFileOutputDelimited_2
							.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("ERS__c");
					outtFileOutputDelimited_2
							.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("Exposure__c");
					outtFileOutputDelimited_2
							.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("Installed_On__c");
					outtFileOutputDelimited_2
							.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("Layer__c");
					outtFileOutputDelimited_2
							.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("OP_Type__c");
					outtFileOutputDelimited_2
							.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("Product__c");
					outtFileOutputDelimited_2
							.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("QC__c");
					outtFileOutputDelimited_2
							.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("QTY__c");
					outtFileOutputDelimited_2
							.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("Revision_Number__c");
					outtFileOutputDelimited_2
							.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("Row_Material__c");
					outtFileOutputDelimited_2
							.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("Scope__c");
					outtFileOutputDelimited_2
							.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("Supply__c");
					outtFileOutputDelimited_2
							.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("System__c");
					outtFileOutputDelimited_2
							.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("Type_Arm__c");
					outtFileOutputDelimited_2
							.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("Type__c");
					outtFileOutputDelimited_2
							.write(OUT_DELIM_tFileOutputDelimited_2);
					outtFileOutputDelimited_2.write("VRL__c");
					outtFileOutputDelimited_2
							.write(OUT_DELIM_tFileOutputDelimited_2);
				...
				class SchemaSettingTool_tSalesforceOutputBulkExec_1_tSalesforceBulkExec_1_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"salesforce_created\",\"type\":\"string\",\"talend.isLocked\":\"false\",\"talend.field.generated\":\"true\",\"talend.field.length\":\"255\"}],\"di.table.name\":\"GoodDescription\",\"di.table.label\":\"Goods_description__c\"}",
								s);
				...
				class SchemaSettingTool_tSalesforceOutputBulkExec_1_tSalesforceBulkExec_2_fisrt {
					...
					String getSchemaValue() {
						...
						a("\"name\":\"error\",\"type\":\"string\",\"talend.isLocked\":\"false\",\"talend.field.generated\":\"true\",\"talend.field.length\":\"255\"}],\"di.table.name\":\"GoodDescription\",\"di.table.label\":\"Goods_description__c\"}",
								s);
				...
				props_tSalesforceOutputBulkExec_1_tSalesforceBulkExec.module
						.setValue("moduleName", "Goods_description__c");
				...
				for (; available_tSalesforceOutputBulkExec_1_tSalesforceBulkExec; available_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = reader_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
					...
					try {
						...
						Object columnValue_0_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(0);
						row5.CurrencyIsoCode = (String) (columnValue_0_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_1_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(1);
						row5.RecordTypeId = (String) (columnValue_1_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_2_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(2);
						row5.CreatedDate = (java.util.Date) (columnValue_2_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						...
						Object columnValue_4_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(4);
						row5.LastModifiedDate = (java.util.Date) (columnValue_4_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						...
						Object columnValue_6_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(6);
						row5.Opportunity_Goods__c = (String) (columnValue_6_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_7_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(7);
						row5.Diameter__c = (String) (columnValue_7_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_8_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(8);
						row5.ERS__c = (String) (columnValue_8_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_9_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(9);
						row5.Exposure__c = (String) (columnValue_9_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_10_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(10);
						row5.Installed_On__c = (String) (columnValue_10_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_11_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(11);
						row5.Layer__c = (String) (columnValue_11_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_12_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(12);
						row5.OP_Type__c = (String) (columnValue_12_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_13_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(13);
						row5.Product__c = (String) (columnValue_13_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_14_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(14);
						row5.QC__c = (String) (columnValue_14_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_15_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(15);
						row5.QTY__c = (Double) (columnValue_15_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_16_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(16);
						row5.Revision_Number__c = (String) (columnValue_16_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_17_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(17);
						row5.Row_Material__c = (String) (columnValue_17_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_18_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(18);
						row5.Scope__c = (String) (columnValue_18_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_19_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(19);
						row5.Supply__c = (String) (columnValue_19_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_20_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(20);
						row5.System__c = (String) (columnValue_20_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_21_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(21);
						row5.Type_Arm__c = (String) (columnValue_21_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_22_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(22);
						row5.Type__c = (String) (columnValue_22_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_23_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(23);
						row5.VRL__c = (String) (columnValue_23_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_24_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(24);
						row5.ExternalIdSplit__c = (String) (columnValue_24_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_25_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(25);
						row5.salesforce_id = (String) (columnValue_25_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						Object columnValue_26_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
								.get(26);
						row5.salesforce_created = (String) (columnValue_26_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						...
						try {
							...
							Object columnValue_6_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
									.get(6);
							row6.Opportunity_Goods__c = (String) (columnValue_6_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
							Object columnValue_7_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
									.get(7);
							row6.Diameter__c = (String) (columnValue_7_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
							Object columnValue_8_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
									.get(8);
							row6.ERS__c = (String) (columnValue_8_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
							Object columnValue_9_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
									.get(9);
							row6.Exposure__c = (String) (columnValue_9_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
							Object columnValue_10_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
									.get(10);
							row6.Installed_On__c = (String) (columnValue_10_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
							Object columnValue_11_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
									.get(11);
							row6.Layer__c = (String) (columnValue_11_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
							Object columnValue_12_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
									.get(12);
							row6.OP_Type__c = (String) (columnValue_12_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
							Object columnValue_13_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
									.get(13);
							row6.Product__c = (String) (columnValue_13_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
							Object columnValue_14_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
									.get(14);
							row6.QC__c = (String) (columnValue_14_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
							Object columnValue_15_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
									.get(15);
							row6.QTY__c = (Double) (columnValue_15_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
							Object columnValue_16_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
									.get(16);
							row6.Revision_Number__c = (String) (columnValue_16_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
							Object columnValue_17_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
									.get(17);
							row6.Row_Material__c = (String) (columnValue_17_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
							Object columnValue_18_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
									.get(18);
							row6.Scope__c = (String) (columnValue_18_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
							Object columnValue_19_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
									.get(19);
							row6.Supply__c = (String) (columnValue_19_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
							Object columnValue_20_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
									.get(20);
							row6.System__c = (String) (columnValue_20_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
							Object columnValue_21_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
									.get(21);
							row6.Type_Arm__c = (String) (columnValue_21_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
							Object columnValue_22_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
									.get(22);
							row6.Type__c = (String) (columnValue_22_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
							Object columnValue_23_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
									.get(23);
							row6.VRL__c = (String) (columnValue_23_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
							Object columnValue_24_tSalesforceOutputBulkExec_1_tSalesforceBulkExec = outgoingEnforcer_tSalesforceOutputBulkExec_1_tSalesforceBulkExec
									.get(24);
							row6.ExternalIdSplit__c = (String) (columnValue_24_tSalesforceOutputBulkExec_1_tSalesforceBulkExec);
						} catch (java.lang.Exception e) {
							// do nothing
						}
					...
					if (row5 != null) {
						...
						if (row5.CurrencyIsoCode != null) {
							sb_tFileOutputDelimited_1
									.append(row5.CurrencyIsoCode);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.RecordTypeId != null) {
							sb_tFileOutputDelimited_1.append(row5.RecordTypeId);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.CreatedDate != null) {
							sb_tFileOutputDelimited_1.append(FormatterUtils
									.format_Date(row5.CreatedDate,
											"yyyy-MM-dd'T'HH:mm:ss'.000Z'"));
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.CreatedById != null) {
							sb_tFileOutputDelimited_1.append(row5.CreatedById);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.LastModifiedDate != null) {
							sb_tFileOutputDelimited_1.append(FormatterUtils
									.format_Date(row5.LastModifiedDate,
											"yyyy-MM-dd'T'HH:mm:ss'.000Z'"));
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.LastModifiedById != null) {
							sb_tFileOutputDelimited_1
									.append(row5.LastModifiedById);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.Opportunity_Goods__c != null) {
							sb_tFileOutputDelimited_1
									.append(row5.Opportunity_Goods__c);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.Diameter__c != null) {
							sb_tFileOutputDelimited_1.append(row5.Diameter__c);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.ERS__c != null) {
							sb_tFileOutputDelimited_1.append(row5.ERS__c);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.Exposure__c != null) {
							sb_tFileOutputDelimited_1.append(row5.Exposure__c);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.Installed_On__c != null) {
							sb_tFileOutputDelimited_1
									.append(row5.Installed_On__c);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.Layer__c != null) {
							sb_tFileOutputDelimited_1.append(row5.Layer__c);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.OP_Type__c != null) {
							sb_tFileOutputDelimited_1.append(row5.OP_Type__c);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.Product__c != null) {
							sb_tFileOutputDelimited_1.append(row5.Product__c);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.QC__c != null) {
							sb_tFileOutputDelimited_1.append(row5.QC__c);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.QTY__c != null) {
							sb_tFileOutputDelimited_1.append(row5.QTY__c);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.Revision_Number__c != null) {
							sb_tFileOutputDelimited_1
									.append(row5.Revision_Number__c);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.Row_Material__c != null) {
							sb_tFileOutputDelimited_1
									.append(row5.Row_Material__c);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.Scope__c != null) {
							sb_tFileOutputDelimited_1.append(row5.Scope__c);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.Supply__c != null) {
							sb_tFileOutputDelimited_1.append(row5.Supply__c);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.System__c != null) {
							sb_tFileOutputDelimited_1.append(row5.System__c);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.Type_Arm__c != null) {
							sb_tFileOutputDelimited_1.append(row5.Type_Arm__c);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.Type__c != null) {
							sb_tFileOutputDelimited_1.append(row5.Type__c);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.VRL__c != null) {
							sb_tFileOutputDelimited_1.append(row5.VRL__c);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.ExternalIdSplit__c != null) {
							sb_tFileOutputDelimited_1
									.append(row5.ExternalIdSplit__c);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.salesforce_id != null) {
							sb_tFileOutputDelimited_1
									.append(row5.salesforce_id);
						}
						sb_tFileOutputDelimited_1
								.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row5.salesforce_created != null) {
							sb_tFileOutputDelimited_1
									.append(row5.salesforce_created);
						}
						sb_tFileOutputDelimited_1
					...
					if (row6 != null) {
						...
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row6.Opportunity_Goods__c != null) {
							sb_tFileOutputDelimited_2
									.append(row6.Opportunity_Goods__c);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row6.Diameter__c != null) {
							sb_tFileOutputDelimited_2.append(row6.Diameter__c);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row6.ERS__c != null) {
							sb_tFileOutputDelimited_2.append(row6.ERS__c);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row6.Exposure__c != null) {
							sb_tFileOutputDelimited_2.append(row6.Exposure__c);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row6.Installed_On__c != null) {
							sb_tFileOutputDelimited_2
									.append(row6.Installed_On__c);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row6.Layer__c != null) {
							sb_tFileOutputDelimited_2.append(row6.Layer__c);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row6.OP_Type__c != null) {
							sb_tFileOutputDelimited_2.append(row6.OP_Type__c);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row6.Product__c != null) {
							sb_tFileOutputDelimited_2.append(row6.Product__c);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row6.QC__c != null) {
							sb_tFileOutputDelimited_2.append(row6.QC__c);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row6.QTY__c != null) {
							sb_tFileOutputDelimited_2.append(row6.QTY__c);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row6.Revision_Number__c != null) {
							sb_tFileOutputDelimited_2
									.append(row6.Revision_Number__c);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row6.Row_Material__c != null) {
							sb_tFileOutputDelimited_2
									.append(row6.Row_Material__c);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row6.Scope__c != null) {
							sb_tFileOutputDelimited_2.append(row6.Scope__c);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row6.Supply__c != null) {
							sb_tFileOutputDelimited_2.append(row6.Supply__c);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row6.System__c != null) {
							sb_tFileOutputDelimited_2.append(row6.System__c);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row6.Type_Arm__c != null) {
							sb_tFileOutputDelimited_2.append(row6.Type_Arm__c);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row6.Type__c != null) {
							sb_tFileOutputDelimited_2.append(row6.Type__c);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
						if (row6.VRL__c != null) {
							sb_tFileOutputDelimited_2.append(row6.VRL__c);
						}
						sb_tFileOutputDelimited_2
								.append(OUT_DELIM_tFileOutputDelimited_2);
	...
	public static class RecordTypePreprodStruct
			implements
			routines.system.IPersistableComparableLookupRow<RecordTypePreprodStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_LOAD_GoodDescription = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_LOAD_GoodDescription = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final RecordTypePreprodStruct other = (RecordTypePreprodStruct) obj;
		...
		public void copyDataTo(RecordTypePreprodStruct other) {
		...
		public void copyKeysDataTo(RecordTypePreprodStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(RecordTypePreprodStruct other) {
	...
	public void tHashInput_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				RecordTypePreprodStruct RecordTypePreprod = new RecordTypePreprodStruct();

				/**
				 * [tAdvancedHash_RecordTypePreprod begin ] start
				 */

				ok_Hash.put("tAdvancedHash_RecordTypePreprod", false);
				start_Hash.put("tAdvancedHash_RecordTypePreprod",
						System.currentTimeMillis());

				currentComponent = "tAdvancedHash_RecordTypePreprod";

				if (execStat) {
					if (resourceMap.get("inIterateVComp") == null) {

						runStat.updateStatOnConnection("RecordTypePreprod"
								+ iterateId, 0, 0);

					}
				}

				int tos_count_tAdvancedHash_RecordTypePreprod = 0;

				// connection name:RecordTypePreprod
				// source node:tHashInput_1 - inputs:(after_tSalesforceInput_5)
				// outputs:(RecordTypePreprod,RecordTypePreprod) | target
				// node:tAdvancedHash_RecordTypePreprod -
				// inputs:(RecordTypePreprod) outputs:()
				// linked node: tMap_1 -
				// inputs:(row3,RecordTypePreprod,CreatedBy,ModifiedBy,Opportunity)
				// outputs:(Goods_description)

				org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_RecordTypePreprod = org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;

				org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<RecordTypePreprodStruct> tHash_Lookup_RecordTypePreprod = org.talend.designer.components.lookup.memory.AdvancedMemoryLookup
						.<RecordTypePreprodStruct> getLookup(matchingModeEnum_RecordTypePreprod);

				globalMap.put("tHash_Lookup_RecordTypePreprod",
						tHash_Lookup_RecordTypePreprod);

				/**
				 * [tAdvancedHash_RecordTypePreprod begin ] stop
				 */
				...
				org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row8Struct> tHashFile_tHashInput_1 = mf_tHashInput_1
						.getAdvancedMemoryHashFile("tHashFile_LOAD_GoodDescription_"
								+ pid + "_tHashOutput_5");
				if (tHashFile_tHashInput_1 == null) {
					throw new RuntimeException(
							"The hash is not initialized : The hash must exist before you read from it");
				}
				java.util.Iterator<row8Struct> iterator_tHashInput_1 = tHashFile_tHashInput_1
						.iterator();
				while (iterator_tHashInput_1.hasNext()) {
					row8Struct next_tHashInput_1 = iterator_tHashInput_1.next();

					RecordTypePreprod.Id = next_tHashInput_1.Id;
					RecordTypePreprod.DeveloperName = next_tHashInput_1.DeveloperName;
					...
					/**
					 * [tAdvancedHash_RecordTypePreprod main ] start
					 */
					...
					RecordTypePreprodStruct RecordTypePreprod_HashRow = new RecordTypePreprodStruct();

					RecordTypePreprod_HashRow.Id = RecordTypePreprod.Id;

					RecordTypePreprod_HashRow.DeveloperName = RecordTypePreprod.DeveloperName;

					tHash_Lookup_RecordTypePreprod
							.put(RecordTypePreprod_HashRow);

					tos_count_tAdvancedHash_RecordTypePreprod++;

					/**
					 * [tAdvancedHash_RecordTypePreprod main ] stop
					 */

					/**
					 * [tAdvancedHash_RecordTypePreprod process_data_begin ]
					 * start
					 */
					...
					/**
					 * [tAdvancedHash_RecordTypePreprod process_data_end ] start
					 */

					currentComponent = "tAdvancedHash_RecordTypePreprod";

					/**
					 * [tAdvancedHash_RecordTypePreprod process_data_end ] stop
					 */
				...
				org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap
						.remove("tHashFile_LOAD_GoodDescription_" + pid
								+ "_tHashOutput_5");
				...
				/**
				 * [tAdvancedHash_RecordTypePreprod end ] start
				 */

				currentComponent = "tAdvancedHash_RecordTypePreprod";

				tHash_Lookup_RecordTypePreprod.endPut();
				...
				ok_Hash.put("tAdvancedHash_RecordTypePreprod", true);
				end_Hash.put("tAdvancedHash_RecordTypePreprod",
						System.currentTimeMillis());

				/**
				 * [tAdvancedHash_RecordTypePreprod end ] stop
				 */
			...
			try {
				...
				/**
				 * [tAdvancedHash_RecordTypePreprod finally ] start
				 */

				currentComponent = "tAdvancedHash_RecordTypePreprod";

				/**
				 * [tAdvancedHash_RecordTypePreprod finally ] stop
				 */
	...
	public void tHashInput_2Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tHashInput_2 - inputs:(after_tSalesforceInput_5)
	...
	public void tHashInput_3Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tHashInput_3 - inputs:(after_tSalesforceInput_5)
	...
	public void tHashInput_4Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tHashInput_4 - inputs:(after_tSalesforceInput_5)
				...
				java.util.Iterator<row2Struct> iterator_tHashInput_4 = tHashFile_tHashInput_4
						.iterator();
				while (iterator_tHashInput_4.hasNext()) {
					row2Struct next_tHashInput_4 = iterator_tHashInput_4.next();

					Opportunity.Id = next_tHashInput_4.Id;
					Opportunity.ExternalIdSplit__c = next_tHashInput_4.ExternalIdSplit__c;
	...
	public void tHashInput_5Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tHashInput_5 - inputs:(after_tSalesforceInput_5)
				// outputs:(row4,row4) | target node:tAdvancedHash_row4 -
				// inputs:(row4) outputs:()
				// linked node: tMap_3 - inputs:(Goods_description,row4)
				// outputs:(GoodDescription)
				...
				org.talend.designer.components.hashfile.common.MapHashFile mf_tHashInput_5 = org.talend.designer.components.hashfile.common.MapHashFile
						.getMapHashFile();
				org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row7Struct> tHashFile_tHashInput_5 = mf_tHashInput_5
						.getAdvancedMemoryHashFile("tHashFile_LOAD_GoodDescription_"
								+ pid + "_tHashOutput_4");
				...
				java.util.Iterator<row7Struct> iterator_tHashInput_5 = tHashFile_tHashInput_5
						.iterator();
				while (iterator_tHashInput_5.hasNext()) {
					row7Struct next_tHashInput_5 = iterator_tHashInput_5.next();

					row4.Id = next_tHashInput_5.Id;
					row4.DeveloperName = next_tHashInput_5.DeveloperName;
					...
					row4_HashRow.DeveloperName = row4.DeveloperName;
	...
	public static void main(String[] args) {
		final LOAD_GoodDescription LOAD_GoodDescriptionClass = new LOAD_GoodDescription();

		int exitCode = LOAD_GoodDescriptionClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = LOAD_GoodDescription.class
					.getClassLoader().getResourceAsStream(
							"local_project/load_gooddescription_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = LOAD_GoodDescription.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : LOAD_GoodDescription");
		}
...
/************************************************************************************************
 * 623364 characters generated by Talend Open Studio for Data Integration on the
 * 6 novembre 2019 15:30:03 CET
 ************************************************************************************************/
