...
package local_project.load_key_account_network_team_0_1;
...
/**
 * Job: LOAD_Key_Account_Network_Team Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class LOAD_Key_Account_Network_Team implements TalendJob {
...
public String getOutFileFolder(){
	...
	private final String jobName = "LOAD_Key_Account_Network_Team";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				LOAD_Key_Account_Network_Team.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(LOAD_Key_Account_Network_Team.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tAdvancedHash_CreatedById_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void tAdvancedHash_LastModifiedById_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void tAdvancedHash_TeamMember_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void tAdvancedHash_KAM_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class row_Implicit_Context_RegexStruct implements routines.system.IPersistableRow<row_Implicit_Context_RegexStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_LOAD_Key_Account_Network_Team = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_LOAD_Key_Account_Network_Team = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_LOAD_Key_Account_Network_Team.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_LOAD_Key_Account_Network_Team.length == 0) {
   					commonByteArray_LOCAL_PROJECT_LOAD_Key_Account_Network_Team = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_LOAD_Key_Account_Network_Team = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_LOAD_Key_Account_Network_Team, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_LOAD_Key_Account_Network_Team, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_LOAD_Key_Account_Network_Team) {
...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
    ...
    static byte[] commonByteArray_LOCAL_PROJECT_LOAD_Key_Account_Network_Team = new byte[0];
			    ...
			    public String KAMs__c;

				public String getKAMs__c () {
					return this.KAMs__c;
				}
				
			    public String Team_Member__c;

				public String getTeam_Member__c () {
					return this.Team_Member__c;
				}
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_LOAD_Key_Account_Network_Team) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.KAMs__c = readString(dis);
					
					this.Team_Member__c = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.KAMs__c,dos);
					
					// String
				
						writeString(this.Team_Member__c,dos);
    ...
    public String toString() {
		...
		sb.append(",KAMs__c="+KAMs__c);
		sb.append(",Team_Member__c="+Team_Member__c);
...
public static class Key_Account_Network_TeamStruct implements routines.system.IPersistableRow<Key_Account_Network_TeamStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_LOAD_Key_Account_Network_Team = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_LOAD_Key_Account_Network_Team = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(Key_Account_Network_TeamStruct other) {
...
Key_Account_Network_TeamStruct Key_Account_Network_Team = new Key_Account_Network_TeamStruct();
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, false),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("LastModifiedById");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("KAMs__c");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("Team_Member__c");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_2, false),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_2.length()==0){
                                        ...
                                        outtFileOutputDelimited_2.write("LastModifiedById");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("KAMs__c");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("Team_Member__c");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("ExternalIdSplit__c");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("errorCode");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("errorFields");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
	...
	currentComponent="tSalesforceOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("Key_Account_Network_Team" + iterateId, 0, 0);
 		                    ...
 		                    class SchemaSettingTool_tSalesforceOutput_1_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"KAMs__c\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"KAMs__c\",\"talend.field.dbColumnName\":\"KAMs__c\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"KAMs__c\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"Team_Member__c\",\"type\":\"string\",\"di.table.comment\":\"\",\"talend.field.dbType\":\"\",\"talend.field.dbColumnName\":\"Team_Member__c\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Team_Member__c\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"ExternalIdSplit__c\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Id\",\"talend.field.dbColumnName\":\"ExternalIdSplit__c\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ExternalIdSplit__c\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"Key_Account_Network_Team\",\"di.table.label\":\"Key_Account_Network_Team__c\"}",s);
 		                    ...
 		                    class SchemaSettingTool_tSalesforceOutput_1_2_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"ExternalIdSplit__c\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Id\",\"talend.field.dbColumnName\":\"ExternalIdSplit__c\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ExternalIdSplit__c\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						...
     		                    						a("\"name\":\"errorMessage\",\"type\":\"string\",\"talend.isLocked\":\"false\",\"talend.field.generated\":\"true\",\"talend.field.length\":\"255\"}],\"di.table.name\":\"Key_Account_Network_Team\",\"di.table.label\":\"Key_Account_Network_Team__c\"}",s);
...
if(componentRuntime_tSalesforceOutput_1 instanceof org.talend.components.api.component.runtime.SourceOrSink) {
    ...
    org.talend.codegen.enforcer.IncomingSchemaEnforcer incomingEnforcer_tSalesforceOutput_1
            = new org.talend.codegen.enforcer.IncomingSchemaEnforcer(designSchema_tSalesforceOutput_1);
                ...
                org.apache.avro.Schema rejectSchema_tSalesforceOutput_1 = props_tSalesforceOutput_1.getSchema(c_tSalesforceOutput_1, true);
        org.talend.codegen.enforcer.OutgoingSchemaEnforcer outgoingEnforcer_tSalesforceOutput_1OutReject = org.talend.codegen.enforcer.EnforcerCreator.createOutgoingEnforcer(rejectSchema_tSalesforceOutput_1, false);
...
// # Lookup's keys initialization
		...
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<CreatedByIdStruct> tHash_Lookup_CreatedById = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<CreatedByIdStruct>) 
				((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<CreatedByIdStruct>) 
					globalMap.get( "tHash_Lookup_CreatedById" ))
					;					
					
	

CreatedByIdStruct CreatedByIdHashKey = new CreatedByIdStruct();
CreatedByIdStruct CreatedByIdDefault = new CreatedByIdStruct();
	
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<LastModifiedByIdStruct> tHash_Lookup_LastModifiedById = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<LastModifiedByIdStruct>) 
				((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<LastModifiedByIdStruct>) 
					globalMap.get( "tHash_Lookup_LastModifiedById" ))
					;					
					
	

LastModifiedByIdStruct LastModifiedByIdHashKey = new LastModifiedByIdStruct();
LastModifiedByIdStruct LastModifiedByIdDefault = new LastModifiedByIdStruct();
	
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<TeamMemberStruct> tHash_Lookup_TeamMember = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<TeamMemberStruct>) 
				((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<TeamMemberStruct>) 
					globalMap.get( "tHash_Lookup_TeamMember" ))
					;					
					
	

TeamMemberStruct TeamMemberHashKey = new TeamMemberStruct();
TeamMemberStruct TeamMemberDefault = new TeamMemberStruct();
	
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<KAMStruct> tHash_Lookup_KAM = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<KAMStruct>) 
				((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<KAMStruct>) 
					globalMap.get( "tHash_Lookup_KAM" ))
					;					
					
	

KAMStruct KAMHashKey = new KAMStruct();
KAMStruct KAMDefault = new KAMStruct();
// ###############################        
...
Key_Account_Network_TeamStruct Key_Account_Network_Team_tmp = new Key_Account_Network_TeamStruct();
// ###############################
 		                    ...
 		                    class SchemaSettingTool_tSalesforceInput_1_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"RBU_BU__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"RBU_BU__c\",\"talend.field.dbColumnName\":\"RBU_BU__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"1300\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"RBU_BU__c\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"Team_Member__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Team_Member__c\",\"talend.field.dbColumnName\":\"Team_Member__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Team_Member__c\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"MAIN\",\"di.table.label\":\"Key_Account_Network_Team__c\"}",s);
	...
	currentComponent="tMap_1";
        ...
        // # Input tables (lookups)
		  ...
		  boolean mainRowRejected_tMap_1 = false;
				...
				///////////////////////////////////////////////
				// Starting Lookup Table "CreatedById" 
				///////////////////////////////////////////////
 					    ...
 					    boolean forceLoopCreatedById = false;
       		  	    	
       		  	    	
 							CreatedByIdStruct CreatedByIdObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		...
                        		    		CreatedByIdHashKey.ExternalIdSplit__c = row2.CreatedById ;
                        		    		

								
		                        	CreatedByIdHashKey.hashCodeDirty = true;
		  							...
		  							tHash_Lookup_CreatedById.lookup( CreatedByIdHashKey );
				           		...
				           		if(tHash_Lookup_CreatedById != null && tHash_Lookup_CreatedById.getCount(CreatedByIdHashKey) > 1) { // G 071
			  							
			  						
									 		
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'CreatedById' and it contains more one result from keys :  CreatedById.ExternalIdSplit__c = '" + CreatedByIdHashKey.ExternalIdSplit__c + "'");
								} // G 071
							

							CreatedByIdStruct CreatedById = null;
                    		  	 
							   
                    		  	 
	       		  	    	CreatedByIdStruct fromLookup_CreatedById = null;
							CreatedById = CreatedByIdDefault;
								...
								if (tHash_Lookup_CreatedById !=null && tHash_Lookup_CreatedById.hasNext()) { // G 099
								
							
								
								fromLookup_CreatedById = tHash_Lookup_CreatedById.next();
							...
							if(fromLookup_CreatedById != null) {
								CreatedById = fromLookup_CreatedById;
							}
				...
				///////////////////////////////////////////////
				// Starting Lookup Table "LastModifiedById" 
				///////////////////////////////////////////////
 					    ...
 					    boolean forceLoopLastModifiedById = false;
       		  	    	
       		  	    	
 							LastModifiedByIdStruct LastModifiedByIdObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		...
                        		    		LastModifiedByIdHashKey.ExternalIdSplit__c = row2.LastModifiedById ;
                        		    		

								
		                        	LastModifiedByIdHashKey.hashCodeDirty = true;
		  							...
		  							tHash_Lookup_LastModifiedById.lookup( LastModifiedByIdHashKey );
				           		...
				           		if(tHash_Lookup_LastModifiedById != null && tHash_Lookup_LastModifiedById.getCount(LastModifiedByIdHashKey) > 1) { // G 071
			  							
			  						
									 		
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'LastModifiedById' and it contains more one result from keys :  LastModifiedById.ExternalIdSplit__c = '" + LastModifiedByIdHashKey.ExternalIdSplit__c + "'");
								} // G 071
							

							LastModifiedByIdStruct LastModifiedById = null;
                    		  	 
							   
                    		  	 
	       		  	    	LastModifiedByIdStruct fromLookup_LastModifiedById = null;
							LastModifiedById = LastModifiedByIdDefault;
										 
							
								 
							
							
								if (tHash_Lookup_LastModifiedById !=null && tHash_Lookup_LastModifiedById.hasNext()) { // G 099
								
							
								
								fromLookup_LastModifiedById = tHash_Lookup_LastModifiedById.next();
							...
							if(fromLookup_LastModifiedById != null) {
								LastModifiedById = fromLookup_LastModifiedById;
							}
				...
				///////////////////////////////////////////////
				// Starting Lookup Table "TeamMember" 
				///////////////////////////////////////////////
 					    ...
 					    boolean forceLoopTeamMember = false;
       		  	    	
       		  	    	
 							TeamMemberStruct TeamMemberObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		...
                        		    		TeamMemberHashKey.ExternalIdSplit__c = row2.Team_Member__c ;
                        		    		

								
		                        	TeamMemberHashKey.hashCodeDirty = true;
		  							...
		  							tHash_Lookup_TeamMember.lookup( TeamMemberHashKey );
				           		...
				           		if(tHash_Lookup_TeamMember != null && tHash_Lookup_TeamMember.getCount(TeamMemberHashKey) > 1) { // G 071
			  							
			  						
									 		
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'TeamMember' and it contains more one result from keys :  TeamMember.ExternalIdSplit__c = '" + TeamMemberHashKey.ExternalIdSplit__c + "'");
								} // G 071
							

							TeamMemberStruct TeamMember = null;
                    		  	 
							   
                    		  	 
	       		  	    	TeamMemberStruct fromLookup_TeamMember = null;
							TeamMember = TeamMemberDefault;
								...
								if (tHash_Lookup_TeamMember !=null && tHash_Lookup_TeamMember.hasNext()) { // G 099
								
							
								
								fromLookup_TeamMember = tHash_Lookup_TeamMember.next();
							...
							if(fromLookup_TeamMember != null) {
								TeamMember = fromLookup_TeamMember;
							}
				...
				///////////////////////////////////////////////
 					    ...
 					    boolean forceLoopKAM = false;
       		  	    	
       		  	    	
 							KAMStruct KAMObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		...
                        		    		KAMHashKey.ExternalIdSplit__c = row2.KAMs__c ;
                        		    		

								
		                        	KAMHashKey.hashCodeDirty = true;
		  							...
		  							tHash_Lookup_KAM.lookup( KAMHashKey );
				           		...
				           		if(tHash_Lookup_KAM != null && tHash_Lookup_KAM.getCount(KAMHashKey) > 1) { // G 071
			  							
			  						
									 		
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'KAM' and it contains more one result from keys :  KAM.ExternalIdSplit__c = '" + KAMHashKey.ExternalIdSplit__c + "'");
								} // G 071
							...
							KAM = KAMDefault;
								...
								if (tHash_Lookup_KAM !=null && tHash_Lookup_KAM.hasNext()) { // G 099
								
							
								
								fromLookup_KAM = tHash_Lookup_KAM.next();
...
Key_Account_Network_Team = null;


// # Output table : 'Key_Account_Network_Team'
Key_Account_Network_Team_tmp.CurrencyIsoCode = row2.CurrencyIsoCode ;
Key_Account_Network_Team_tmp.CreatedDate = row2.CreatedDate ;
Key_Account_Network_Team_tmp.CreatedById = CreatedById.Id ;
Key_Account_Network_Team_tmp.LastModifiedDate = row2.LastModifiedDate ;
Key_Account_Network_Team_tmp.LastModifiedById = LastModifiedById.Id ;
Key_Account_Network_Team_tmp.KAMs__c = KAM.Id ;
Key_Account_Network_Team_tmp.Team_Member__c = TeamMember.Id ;
Key_Account_Network_Team_tmp.ExternalIdSplit__c = row2.Id ;
Key_Account_Network_Team = Key_Account_Network_Team_tmp;
// ###############################
 ...
 */
// Start of branch "Key_Account_Network_Team"
if(Key_Account_Network_Team != null) { 
			row8 = null;
	...
	currentComponent="tSalesforceOutput_1";
			...
			//Key_Account_Network_Team
			//Key_Account_Network_Team


			
				if(execStat){
					runStat.updateStatOnConnection("Key_Account_Network_Team"+iterateId,1, 1);
				} 
            ...
            incomingEnforcer_tSalesforceOutput_1.createNewRecord();
                    ...
                    if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("CurrencyIsoCode") != null){
                        incomingEnforcer_tSalesforceOutput_1.put("CurrencyIsoCode", Key_Account_Network_Team.CurrencyIsoCode);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("CreatedDate") != null){
                        incomingEnforcer_tSalesforceOutput_1.put("CreatedDate", Key_Account_Network_Team.CreatedDate);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("CreatedById") != null){
                        incomingEnforcer_tSalesforceOutput_1.put("CreatedById", Key_Account_Network_Team.CreatedById);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("LastModifiedDate") != null){
                        incomingEnforcer_tSalesforceOutput_1.put("LastModifiedDate", Key_Account_Network_Team.LastModifiedDate);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("LastModifiedById") != null){
                        incomingEnforcer_tSalesforceOutput_1.put("LastModifiedById", Key_Account_Network_Team.LastModifiedById);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("KAMs__c") != null){
                        incomingEnforcer_tSalesforceOutput_1.put("KAMs__c", Key_Account_Network_Team.KAMs__c);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("Team_Member__c") != null){
                        incomingEnforcer_tSalesforceOutput_1.put("Team_Member__c", Key_Account_Network_Team.Team_Member__c);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("ExternalIdSplit__c") != null){
                        incomingEnforcer_tSalesforceOutput_1.put("ExternalIdSplit__c", Key_Account_Network_Team.ExternalIdSplit__c);
                    }
 ...
 */
	...
	currentComponent="tSalesforceOutput_1";
                ...
                if (writer_tSalesforceOutput_1 instanceof org.talend.components.api.component.runtime.WriterWithFeedback) {
					     ...
					     writerWithFeedbackReject_tSalesforceOutput_1 = new org.talend.codegen.flowvariables.runtime.FlowVariablesWriter(writerWithFeedbackReject_tSalesforceOutput_1, container_tSalesforceOutput_1);
					     java.lang.Iterable<?> outgoingRejectRecs_tSalesforceOutput_1 = writerWithFeedbackReject_tSalesforceOutput_1.getRejectedWrites();
                    java.util.Iterator outgoingRejectRecords_tSalesforceOutput_1 = outgoingRejectRecs_tSalesforceOutput_1.iterator();
            	...
            	java.util.Iterator outgoingRejectRecordsIt_tSalesforceOutput_1 = outgoingRejectRecordsList_tSalesforceOutput_1.iterator();
            	while(outgoingMainRecordsIt_tSalesforceOutput_1.hasNext() || outgoingRejectRecordsIt_tSalesforceOutput_1.hasNext()) { //Start of data processing while block
        ...
        outgoingEnforcer_tSalesforceOutput_1OutMain.setWrapped(factory_tSalesforceOutput_1OutMain.convertToAvro(outgoingMain_tSalesforceOutput_1));
                Object columnValue_0_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain.get(0);
                        row7.CurrencyIsoCode = (String) (columnValue_0_tSalesforceOutput_1OutMain);
                Object columnValue_1_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain.get(1);
                        row7.CreatedDate = (java.util.Date) (columnValue_1_tSalesforceOutput_1OutMain);
                Object columnValue_2_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain.get(2);
                        row7.CreatedById = (String) (columnValue_2_tSalesforceOutput_1OutMain);
                Object columnValue_3_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain.get(3);
                        row7.LastModifiedDate = (java.util.Date) (columnValue_3_tSalesforceOutput_1OutMain);
                Object columnValue_4_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain.get(4);
                        row7.LastModifiedById = (String) (columnValue_4_tSalesforceOutput_1OutMain);
                Object columnValue_5_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain.get(5);
                        row7.KAMs__c = (String) (columnValue_5_tSalesforceOutput_1OutMain);
                Object columnValue_6_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain.get(6);
                        row7.Team_Member__c = (String) (columnValue_6_tSalesforceOutput_1OutMain);
                Object columnValue_7_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain.get(7);
                        row7.ExternalIdSplit__c = (String) (columnValue_7_tSalesforceOutput_1OutMain);
            			} else {
            				row7 = null;
            			}
            			...
            			if(outgoingRejectRecordsIt_tSalesforceOutput_1.hasNext()) {
            				row8 = new row8Struct();
            				Object outgoingReject_tSalesforceOutput_1 = outgoingRejectRecordsIt_tSalesforceOutput_1.next();
            				
        // Construct the factory once when the first data arrives.
        if (factory_tSalesforceOutput_1OutReject == null) {
            factory_tSalesforceOutput_1OutReject = (org.talend.daikon.avro.converter.IndexedRecordConverter<Object, ? extends org.apache.avro.generic.IndexedRecord>)
                    new org.talend.daikon.avro.AvroRegistry()
                            .createIndexedRecordConverter(outgoingReject_tSalesforceOutput_1.getClass());
        }

        // Enforce the outgoing schema on the input.
        outgoingEnforcer_tSalesforceOutput_1OutReject.setWrapped(factory_tSalesforceOutput_1OutReject.convertToAvro(outgoingReject_tSalesforceOutput_1));
                Object columnValue_0_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(0);
                        row8.CurrencyIsoCode = (String) (columnValue_0_tSalesforceOutput_1OutReject);
                Object columnValue_1_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(1);
                        row8.CreatedDate = (java.util.Date) (columnValue_1_tSalesforceOutput_1OutReject);
                Object columnValue_2_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(2);
                        row8.CreatedById = (String) (columnValue_2_tSalesforceOutput_1OutReject);
                Object columnValue_3_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(3);
                        row8.LastModifiedDate = (java.util.Date) (columnValue_3_tSalesforceOutput_1OutReject);
                Object columnValue_4_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(4);
                        row8.LastModifiedById = (String) (columnValue_4_tSalesforceOutput_1OutReject);
                Object columnValue_5_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(5);
                        row8.KAMs__c = (String) (columnValue_5_tSalesforceOutput_1OutReject);
                Object columnValue_6_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(6);
                        row8.Team_Member__c = (String) (columnValue_6_tSalesforceOutput_1OutReject);
                Object columnValue_7_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(7);
                        row8.ExternalIdSplit__c = (String) (columnValue_7_tSalesforceOutput_1OutReject);
                Object columnValue_8_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(8);
                        row8.errorCode = (String) (columnValue_8_tSalesforceOutput_1OutReject);
                Object columnValue_9_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(9);
                        row8.errorFields = (String) (columnValue_9_tSalesforceOutput_1OutReject);
                Object columnValue_10_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(10);
                        row8.errorMessage = (String) (columnValue_10_tSalesforceOutput_1OutReject);
            			} else {
            				row8 = null;
            			}
				...
				if(execStat){
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            row7.CurrencyIsoCode
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.CreatedDate != null) {
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(row7.CreatedDate, "yyyy-MM-dd'T'HH:mm:ss'.000Z'")
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(row7.LastModifiedDate, "yyyy-MM-dd'T'HH:mm:ss'.000Z'")
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.LastModifiedById != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.LastModifiedById
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.KAMs__c != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.KAMs__c
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.Team_Member__c != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.Team_Member__c
                        );
                            }
			...
			//row8
				...
				if(execStat){
                    ...
                    StringBuilder sb_tFileOutputDelimited_2 = new StringBuilder();
                            if(row8.CurrencyIsoCode != null) {
                        sb_tFileOutputDelimited_2.append(
                            row8.CurrencyIsoCode
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row8.CreatedDate != null) {
                        sb_tFileOutputDelimited_2.append(
                            FormatterUtils.format_Date(row8.CreatedDate, "yyyy-MM-dd'T'HH:mm:ss'.000Z'")
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row8.CreatedById != null) {
                        sb_tFileOutputDelimited_2.append(
                            row8.CreatedById
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row8.LastModifiedDate != null) {
                        sb_tFileOutputDelimited_2.append(
                            FormatterUtils.format_Date(row8.LastModifiedDate, "yyyy-MM-dd'T'HH:mm:ss'.000Z'")
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row8.LastModifiedById != null) {
                        sb_tFileOutputDelimited_2.append(
                            row8.LastModifiedById
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row8.KAMs__c != null) {
                        sb_tFileOutputDelimited_2.append(
                            row8.KAMs__c
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row8.Team_Member__c != null) {
                        sb_tFileOutputDelimited_2.append(
                            row8.Team_Member__c
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row8.ExternalIdSplit__c != null) {
                        sb_tFileOutputDelimited_2.append(
                            row8.ExternalIdSplit__c
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
...
} // End of branch "Key_Account_Network_Team"
...
// # Lookup hashes releasing
					if(tHash_Lookup_CreatedById != null) {
						tHash_Lookup_CreatedById.endGet();
					}
					globalMap.remove( "tHash_Lookup_CreatedById" );

					
					
				
					if(tHash_Lookup_LastModifiedById != null) {
						tHash_Lookup_LastModifiedById.endGet();
					}
					globalMap.remove( "tHash_Lookup_LastModifiedById" );

					
					
				
					if(tHash_Lookup_TeamMember != null) {
						tHash_Lookup_TeamMember.endGet();
					}
					globalMap.remove( "tHash_Lookup_TeamMember" );

					
					
				
					if(tHash_Lookup_KAM != null) {
						tHash_Lookup_KAM.endGet();
					}
					globalMap.remove( "tHash_Lookup_KAM" );
...
if(resultMap_tSalesforceOutput_1!=null) {
	for(java.util.Map.Entry<String,Object> entry_tSalesforceOutput_1 : resultMap_tSalesforceOutput_1.entrySet()) {
		...
		default :
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("Key_Account_Network_Team"+iterateId,2, 0); 
			 	}
			}
...
public static class CreatedByIdStruct implements routines.system.IPersistableComparableLookupRow<CreatedByIdStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_LOAD_Key_Account_Network_Team = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_LOAD_Key_Account_Network_Team = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final CreatedByIdStruct other = (CreatedByIdStruct) obj;
	...
	public void copyDataTo(CreatedByIdStruct other) {
	...
	public void copyKeysDataTo(CreatedByIdStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(CreatedByIdStruct other) {
...
public void tHashInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		CreatedByIdStruct CreatedById = new CreatedByIdStruct();
	...
	/**
	 * [tAdvancedHash_CreatedById begin ] start
	 */
		...
		ok_Hash.put("tAdvancedHash_CreatedById", false);
		start_Hash.put("tAdvancedHash_CreatedById", System.currentTimeMillis());
		
	
	currentComponent="tAdvancedHash_CreatedById";

	
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
					
						runStat.updateStatOnConnection("CreatedById" + iterateId, 0, 0);
					
				}
			} 

		
		int tos_count_tAdvancedHash_CreatedById = 0;
		

			   		// connection name:CreatedById
			   		// source node:tHashInput_1 - inputs:(after_tSalesforceInput_1) outputs:(CreatedById,CreatedById) | target node:tAdvancedHash_CreatedById - inputs:(CreatedById) outputs:()
			   		// linked node: tMap_1 - inputs:(row2,CreatedById,LastModifiedById,TeamMember,KAM) outputs:(Key_Account_Network_Team)
			   
			   		org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_CreatedById = 
			   			org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
			   			
			   
	   			org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<CreatedByIdStruct> tHash_Lookup_CreatedById =org.talend.designer.components.lookup.memory.AdvancedMemoryLookup.
	   						<CreatedByIdStruct>getLookup(matchingModeEnum_CreatedById);
	   						   
		   	   	   globalMap.put("tHash_Lookup_CreatedById", tHash_Lookup_CreatedById);
...
/**
 * [tAdvancedHash_CreatedById begin ] stop
 */
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row1Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_LOAD_Key_Account_Network_Team_" + pid +"_tHashOutput_1");
...
while (iterator_tHashInput_1.hasNext()) {
	...
	CreatedById.Id = next_tHashInput_1.Id;
	CreatedById.ExternalIdSplit__c = next_tHashInput_1.ExternalIdSplit__c;
 ...
 */
	...
	/**
	 * [tAdvancedHash_CreatedById main ] start
	 */
	...
	currentComponent="tAdvancedHash_CreatedById";
			...
			//CreatedById
				...
				if(execStat){
					runStat.updateStatOnConnection("CreatedById"+iterateId,1, 1);
				} 
					...
					CreatedByIdStruct CreatedById_HashRow = new CreatedByIdStruct();
		   	   	   
				
				CreatedById_HashRow.Id = CreatedById.Id;
				
				CreatedById_HashRow.ExternalIdSplit__c = CreatedById.ExternalIdSplit__c;
				
			tHash_Lookup_CreatedById.put(CreatedById_HashRow);
	...
	tos_count_tAdvancedHash_CreatedById++;

/**
 * [tAdvancedHash_CreatedById main ] stop
 */
	
	/**
	 * [tAdvancedHash_CreatedById process_data_begin ] start
	 */
...
/**
 * [tAdvancedHash_CreatedById process_data_begin ] stop
 */
	
	/**
	 * [tAdvancedHash_CreatedById process_data_end ] start
	 */
...
/**
 * [tAdvancedHash_CreatedById process_data_end ] stop
 */
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_LOAD_Key_Account_Network_Team_" + pid +"_tHashOutput_1");
 ...
 */
	...
	/**
	 * [tAdvancedHash_CreatedById end ] start
	 */
...
tHash_Lookup_CreatedById.endPut();

			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("CreatedById"+iterateId,2, 0); 
			 	}
			}
		
 

ok_Hash.put("tAdvancedHash_CreatedById", true);
end_Hash.put("tAdvancedHash_CreatedById", System.currentTimeMillis());




/**
 * [tAdvancedHash_CreatedById end ] stop
 */
 ...
 */
	...
	/**
	 * [tAdvancedHash_CreatedById finally ] start
	 */
...
/**
 * [tAdvancedHash_CreatedById finally ] stop
 */
...
public static class LastModifiedByIdStruct implements routines.system.IPersistableComparableLookupRow<LastModifiedByIdStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_LOAD_Key_Account_Network_Team = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_LOAD_Key_Account_Network_Team = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final LastModifiedByIdStruct other = (LastModifiedByIdStruct) obj;
	...
	public void copyDataTo(LastModifiedByIdStruct other) {
	...
	public void copyKeysDataTo(LastModifiedByIdStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(LastModifiedByIdStruct other) {
...
public void tHashInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		LastModifiedByIdStruct LastModifiedById = new LastModifiedByIdStruct();
	...
	/**
	 * [tAdvancedHash_LastModifiedById begin ] start
	 */
		...
		ok_Hash.put("tAdvancedHash_LastModifiedById", false);
		start_Hash.put("tAdvancedHash_LastModifiedById", System.currentTimeMillis());
		
	
	currentComponent="tAdvancedHash_LastModifiedById";

	
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
					
						runStat.updateStatOnConnection("LastModifiedById" + iterateId, 0, 0);
					
				}
			} 

		
		int tos_count_tAdvancedHash_LastModifiedById = 0;
		

			   		// connection name:LastModifiedById
			   		// source node:tHashInput_2 - inputs:(after_tSalesforceInput_1) outputs:(LastModifiedById,LastModifiedById) | target node:tAdvancedHash_LastModifiedById - inputs:(LastModifiedById) outputs:()
			   		// linked node: tMap_1 - inputs:(row2,CreatedById,LastModifiedById,TeamMember,KAM) outputs:(Key_Account_Network_Team)
			   
			   		org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_LastModifiedById = 
			   			org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
			   			
			   
	   			org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<LastModifiedByIdStruct> tHash_Lookup_LastModifiedById =org.talend.designer.components.lookup.memory.AdvancedMemoryLookup.
	   						<LastModifiedByIdStruct>getLookup(matchingModeEnum_LastModifiedById);
	   						   
		   	   	   globalMap.put("tHash_Lookup_LastModifiedById", tHash_Lookup_LastModifiedById);
...
/**
 * [tAdvancedHash_LastModifiedById begin ] stop
 */
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row1Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_LOAD_Key_Account_Network_Team_" + pid +"_tHashOutput_1");
...
while (iterator_tHashInput_2.hasNext()) {
	...
	LastModifiedById.Id = next_tHashInput_2.Id;
	LastModifiedById.ExternalIdSplit__c = next_tHashInput_2.ExternalIdSplit__c;
 ...
 */
	...
	/**
	 * [tAdvancedHash_LastModifiedById main ] start
	 */
	...
	currentComponent="tAdvancedHash_LastModifiedById";
			...
			//LastModifiedById
				...
				if(execStat){
					runStat.updateStatOnConnection("LastModifiedById"+iterateId,1, 1);
				} 
					...
					LastModifiedByIdStruct LastModifiedById_HashRow = new LastModifiedByIdStruct();
		   	   	   
				
				LastModifiedById_HashRow.Id = LastModifiedById.Id;
				
				LastModifiedById_HashRow.ExternalIdSplit__c = LastModifiedById.ExternalIdSplit__c;
				
			tHash_Lookup_LastModifiedById.put(LastModifiedById_HashRow);
	...
	tos_count_tAdvancedHash_LastModifiedById++;

/**
 * [tAdvancedHash_LastModifiedById main ] stop
 */
	
	/**
	 * [tAdvancedHash_LastModifiedById process_data_begin ] start
	 */
...
/**
 * [tAdvancedHash_LastModifiedById process_data_begin ] stop
 */
	
	/**
	 * [tAdvancedHash_LastModifiedById process_data_end ] start
	 */
...
/**
 * [tAdvancedHash_LastModifiedById process_data_end ] stop
 */
 ...
 */
	...
	/**
	 * [tAdvancedHash_LastModifiedById end ] start
	 */
...
tHash_Lookup_LastModifiedById.endPut();

			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("LastModifiedById"+iterateId,2, 0); 
			 	}
			}
		
 

ok_Hash.put("tAdvancedHash_LastModifiedById", true);
end_Hash.put("tAdvancedHash_LastModifiedById", System.currentTimeMillis());




/**
 * [tAdvancedHash_LastModifiedById end ] stop
 */
 ...
 */
	...
	/**
	 * [tAdvancedHash_LastModifiedById finally ] start
	 */
...
/**
 * [tAdvancedHash_LastModifiedById finally ] stop
 */
...
public static class TeamMemberStruct implements routines.system.IPersistableComparableLookupRow<TeamMemberStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_LOAD_Key_Account_Network_Team = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_LOAD_Key_Account_Network_Team = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final TeamMemberStruct other = (TeamMemberStruct) obj;
	...
	public void copyDataTo(TeamMemberStruct other) {
	...
	public void copyKeysDataTo(TeamMemberStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(TeamMemberStruct other) {
...
public void tHashInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		TeamMemberStruct TeamMember = new TeamMemberStruct();
	...
	/**
	 * [tAdvancedHash_TeamMember begin ] start
	 */
		...
		ok_Hash.put("tAdvancedHash_TeamMember", false);
		start_Hash.put("tAdvancedHash_TeamMember", System.currentTimeMillis());
		
	
	currentComponent="tAdvancedHash_TeamMember";

	
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
					
						runStat.updateStatOnConnection("TeamMember" + iterateId, 0, 0);
					
				}
			} 

		
		int tos_count_tAdvancedHash_TeamMember = 0;
		

			   		// connection name:TeamMember
			   		// source node:tHashInput_3 - inputs:(after_tSalesforceInput_1) outputs:(TeamMember,TeamMember) | target node:tAdvancedHash_TeamMember - inputs:(TeamMember) outputs:()
			   		// linked node: tMap_1 - inputs:(row2,CreatedById,LastModifiedById,TeamMember,KAM) outputs:(Key_Account_Network_Team)
			   
			   		org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_TeamMember = 
			   			org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
			   			
			   
	   			org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<TeamMemberStruct> tHash_Lookup_TeamMember =org.talend.designer.components.lookup.memory.AdvancedMemoryLookup.
	   						<TeamMemberStruct>getLookup(matchingModeEnum_TeamMember);
	   						   
		   	   	   globalMap.put("tHash_Lookup_TeamMember", tHash_Lookup_TeamMember);
...
/**
 * [tAdvancedHash_TeamMember begin ] stop
 */
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row1Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_LOAD_Key_Account_Network_Team_" + pid +"_tHashOutput_1");
...
while (iterator_tHashInput_3.hasNext()) {
	...
	TeamMember.Id = next_tHashInput_3.Id;
	TeamMember.ExternalIdSplit__c = next_tHashInput_3.ExternalIdSplit__c;
 ...
 */
	...
	/**
	 * [tAdvancedHash_TeamMember main ] start
	 */
	...
	currentComponent="tAdvancedHash_TeamMember";
			...
			//TeamMember
				...
				if(execStat){
					runStat.updateStatOnConnection("TeamMember"+iterateId,1, 1);
				} 
					...
					TeamMemberStruct TeamMember_HashRow = new TeamMemberStruct();
		   	   	   
				
				TeamMember_HashRow.Id = TeamMember.Id;
				
				TeamMember_HashRow.ExternalIdSplit__c = TeamMember.ExternalIdSplit__c;
				
			tHash_Lookup_TeamMember.put(TeamMember_HashRow);
	...
	tos_count_tAdvancedHash_TeamMember++;

/**
 * [tAdvancedHash_TeamMember main ] stop
 */
	
	/**
	 * [tAdvancedHash_TeamMember process_data_begin ] start
	 */
...
/**
 * [tAdvancedHash_TeamMember process_data_begin ] stop
 */
	
	/**
	 * [tAdvancedHash_TeamMember process_data_end ] start
	 */
...
/**
 * [tAdvancedHash_TeamMember process_data_end ] stop
 */
 ...
 */
	...
	/**
	 * [tAdvancedHash_TeamMember end ] start
	 */
...
tHash_Lookup_TeamMember.endPut();

			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("TeamMember"+iterateId,2, 0); 
			 	}
			}
		
 

ok_Hash.put("tAdvancedHash_TeamMember", true);
end_Hash.put("tAdvancedHash_TeamMember", System.currentTimeMillis());




/**
 * [tAdvancedHash_TeamMember end ] stop
 */
 ...
 */
	...
	/**
	 * [tAdvancedHash_TeamMember finally ] start
	 */
...
/**
 * [tAdvancedHash_TeamMember finally ] stop
 */
...
public static class KAMStruct implements routines.system.IPersistableComparableLookupRow<KAMStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_LOAD_Key_Account_Network_Team = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_LOAD_Key_Account_Network_Team = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final KAMStruct other = (KAMStruct) obj;
	...
	public void copyDataTo(KAMStruct other) {
	...
	public void copyKeysDataTo(KAMStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(KAMStruct other) {
...
public void tHashInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		ok_Hash.put("tAdvancedHash_KAM", false);
		start_Hash.put("tAdvancedHash_KAM", System.currentTimeMillis());
		
	
	currentComponent="tAdvancedHash_KAM";

	
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
					
						runStat.updateStatOnConnection("KAM" + iterateId, 0, 0);
					
				}
			} 

		
		int tos_count_tAdvancedHash_KAM = 0;
		

			   		// connection name:KAM
			   		// source node:tHashInput_4 - inputs:(after_tSalesforceInput_1) outputs:(KAM,KAM) | target node:tAdvancedHash_KAM - inputs:(KAM) outputs:()
			   		// linked node: tMap_1 - inputs:(row2,CreatedById,LastModifiedById,TeamMember,KAM) outputs:(Key_Account_Network_Team)
			   
			   		org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_KAM = 
			   			org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
			   			
			   
	   			org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<KAMStruct> tHash_Lookup_KAM =org.talend.designer.components.lookup.memory.AdvancedMemoryLookup.
	   						<KAMStruct>getLookup(matchingModeEnum_KAM);
	   						   
		   	   	   globalMap.put("tHash_Lookup_KAM", tHash_Lookup_KAM);
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row6Struct> tHashFile_tHashInput_4 = mf_tHashInput_4.getAdvancedMemoryHashFile("tHashFile_LOAD_Key_Account_Network_Team_" + pid +"_tHashOutput_2");
...
while (iterator_tHashInput_4.hasNext()) {
	...
	KAM.Id = next_tHashInput_4.Id;
	KAM.ExternalIdSplit__c = next_tHashInput_4.ExternalIdSplit__c;
 ...
 */
	...
	currentComponent="tAdvancedHash_KAM";
			...
			//KAM
				...
				if(execStat){
					runStat.updateStatOnConnection("KAM"+iterateId,1, 1);
				} 
					...
					KAMStruct KAM_HashRow = new KAMStruct();
		   	   	   
				
				KAM_HashRow.Id = KAM.Id;
				
				KAM_HashRow.ExternalIdSplit__c = KAM.ExternalIdSplit__c;
				
			tHash_Lookup_KAM.put(KAM_HashRow);
	...
	tos_count_tAdvancedHash_KAM++;

/**
 * [tAdvancedHash_KAM main ] stop
 */
	
	/**
	 * [tAdvancedHash_KAM process_data_begin ] start
	 */
...
/**
 * [tAdvancedHash_KAM process_data_begin ] stop
 */
	
	/**
	 * [tAdvancedHash_KAM process_data_end ] start
	 */
...
/**
 * [tAdvancedHash_KAM process_data_end ] stop
 */
 ...
 */
	...
	currentComponent="tHashInput_4";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_LOAD_Key_Account_Network_Team_" + pid +"_tHashOutput_2");
...
tHash_Lookup_KAM.endPut();

			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("KAM"+iterateId,2, 0); 
			 	}
			}
		
 

ok_Hash.put("tAdvancedHash_KAM", true);
end_Hash.put("tAdvancedHash_KAM", System.currentTimeMillis());




/**
 * [tAdvancedHash_KAM end ] stop
 */
 ...
 */
	...
	/**
	 * [tAdvancedHash_KAM finally ] start
	 */
...
/**
 * [tAdvancedHash_KAM finally ] stop
 */
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_LOAD_Key_Account_Network_Team_" + pid + "_tHashOutput_1";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_LOAD_Key_Account_Network_Team_" + pid + "_tHashOutput_2";
 		                    ...
 		                    class SchemaSettingTool_tSalesforceInput_3_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"KAM__c\",\"fields\":[{",s);
     		                    						
     		                    						a("\"name\":\"Id\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Id\",\"talend.field.dbColumnName\":\"Id\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Id\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"ExternalIdSplit__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ExternalIdSplit__c\",\"talend.field.dbColumnName\":\"ExternalIdSplit__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ExternalIdSplit__c\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"MAIN\",\"di.table.label\":\"KAM__c\"}",s);
 ...
 */
				    			...
				    			if(resumeEntryMethodName == null || globalResumeTicket){
				    				resumeUtil.addLog("CHECKPOINT", "CONNECTION:SUBJOB_OK:tSalesforceInput_3:OnSubjobOk", "", Thread.currentThread().getId() + "", "", "", "", "", "");
								}	    				    			
 ...
 */
    ...
    public static void main(String[] args){
        final LOAD_Key_Account_Network_Team LOAD_Key_Account_Network_TeamClass = new LOAD_Key_Account_Network_Team();

        int exitCode = LOAD_Key_Account_Network_TeamClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = LOAD_Key_Account_Network_Team.class.getClassLoader().getResourceAsStream("local_project/load_key_account_network_team_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = LOAD_Key_Account_Network_Team.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LOAD_Key_Account_Network_Team");
        }
...
/************************************************************************************************
 *     417966 characters generated by Talend Open Studio for Data Integration 
 *     on the 8 novembre 2019 12:12:32 CET
 ************************************************************************************************/