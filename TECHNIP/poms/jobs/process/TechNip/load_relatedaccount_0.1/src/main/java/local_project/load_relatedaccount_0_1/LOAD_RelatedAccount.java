...
package local_project.load_relatedaccount_0_1;
...
/**
 * Job: LOAD_RelatedAccount Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class LOAD_RelatedAccount implements TalendJob {
...
public String getOutput(){
	...
	private final String jobName = "LOAD_RelatedAccount";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				LOAD_RelatedAccount.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(LOAD_RelatedAccount.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tAdvancedHash_Opportunity_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
			...
			public void tAdvancedHash_Owner_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class row_Implicit_Context_RegexStruct implements routines.system.IPersistableRow<row_Implicit_Context_RegexStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_LOAD_RelatedAccount = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_LOAD_RelatedAccount = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_LOAD_RelatedAccount.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_LOAD_RelatedAccount.length == 0) {
   					commonByteArray_LOCAL_PROJECT_LOAD_RelatedAccount = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_LOAD_RelatedAccount = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_LOAD_RelatedAccount, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_LOAD_RelatedAccount, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_LOAD_RelatedAccount) {
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_1=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_1 = "tHashFile_LOAD_RelatedAccount_" + pid + "_tHashOutput_1";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_2=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_2 = "tHashFile_LOAD_RelatedAccount_" + pid + "_tHashOutput_2";
...
org.talend.designer.components.hashfile.common.MapHashFile mf_tHashOutput_3=org.talend.designer.components.hashfile.common.MapHashFile.getMapHashFile();    
		...
		String hashKey_tHashOutput_3 = "tHashFile_LOAD_RelatedAccount_" + pid + "_tHashOutput_3";
 		                    ...
 		                    class SchemaSettingTool_tSalesforceInput_1_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"ExternalIdSplit__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ExternalIdSplit__c\",\"talend.field.dbColumnName\":\"ExternalIdSplit__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ExternalIdSplit__c\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"MAIN\",\"di.table.label\":\"Opportunity\"}",s);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.Account__c,dos);
...
public static class RelatedAccountStruct implements routines.system.IPersistableRow<RelatedAccountStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_LOAD_RelatedAccount = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_LOAD_RelatedAccount = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(RelatedAccountStruct other) {
...
RelatedAccountStruct RelatedAccount = new RelatedAccountStruct();
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, false),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        ...
                                        outtFileOutputDelimited_1.write("LastModifiedById");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("Account__c");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("ExternalIdSAMS__c");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("Opportunity__c");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                                        outtFileOutputDelimited_1.write("Role__c");
                                            outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_2, false),"ISO-8859-15"));
                                    if(filetFileOutputDelimited_2.length()==0){
                                        ...
                                        outtFileOutputDelimited_2.write("LastModifiedById");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("Account__c");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("ExternalIdSAMS__c");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("Opportunity__c");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
                                        outtFileOutputDelimited_2.write("Role__c");
                                            outtFileOutputDelimited_2.write(OUT_DELIM_tFileOutputDelimited_2);
	...
	currentComponent="tSalesforceOutput_1";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("RelatedAccount" + iterateId, 0, 0);
 		                    ...
 		                    class SchemaSettingTool_tSalesforceOutput_1_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"Related_Accounts__c\",\"fields\":[{",s);
     		                    						...
     		                    						a("\"name\":\"Account__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Account__c\",\"talend.field.dbColumnName\":\"Account__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Account__c\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"ExternalIdSAMS__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ExternalIdSAMS__c\",\"talend.field.dbColumnName\":\"ExternalIdSAMS__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ExternalIdSAMS__c\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"Opportunity__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Opportunity__c\",\"talend.field.dbColumnName\":\"Opportunity__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Opportunity__c\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"Role__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Role__c\",\"talend.field.dbColumnName\":\"Role__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"255\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"Role__c\",\"di.column.relatedEntity\":\"\"},{",s);
     		                    						
     		                    						a("\"name\":\"ExternalIdSplit__c\",\"type\":\"string\",\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"Id\",\"talend.field.dbColumnName\":\"ExternalIdSplit__c\",\"di.column.talendType\":\"id_String\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ExternalIdSplit__c\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"RelatedAccount\",\"di.table.label\":\"Related_Accounts__c\"}",s);
 		                    ...
 		                    class SchemaSettingTool_tSalesforceOutput_1_2_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"errorMessage\",\"type\":\"string\",\"talend.isLocked\":\"false\",\"talend.field.generated\":\"true\",\"talend.field.length\":\"255\"}],\"di.table.name\":\"RelatedAccount\",\"di.table.label\":\"Related_Accounts__c\"}",s);
...
ModifiedByStruct ModifiedByDefault = new ModifiedByStruct();
		...
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<OpportunityStruct> tHash_Lookup_Opportunity = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<OpportunityStruct>) 
				((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<OpportunityStruct>) 
					globalMap.get( "tHash_Lookup_Opportunity" ))
					;					
...
AccountStruct AccountDefault = new AccountStruct();
		...
		org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<OwnerStruct> tHash_Lookup_Owner = (org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<OwnerStruct>) 
				((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<OwnerStruct>) 
					globalMap.get( "tHash_Lookup_Owner" ))
					;					
...
RelatedAccountStruct RelatedAccount_tmp = new RelatedAccountStruct();
// ###############################
 		                    ...
 		                    class SchemaSettingTool_tSalesforceInput_4_1_fisrt {
 		                    		...
 		                    		String getSchemaValue() {
 		                    						...
 		                    						StringBuilder s = new StringBuilder();
     		                    						...
     		                    						a("\"name\":\"ExternalIdSAMS__c\",\"type\":[\"string\",\"null\"],\"di.table.comment\":\"\",\"AVRO_TECHNICAL_KEY\":\"ExternalIdSAMS__c\",\"talend.field.dbColumnName\":\"ExternalIdSAMS__c\",\"di.column.talendType\":\"id_String\",\"di.column.isNullable\":\"true\",\"talend.field.pattern\":\"\",\"talend.field.length\":\"18\",\"di.column.relationshipType\":\"\",\"di.table.label\":\"ExternalIdSAMS__c\",\"di.column.relatedEntity\":\"\"}],\"di.table.name\":\"MAIN\",\"di.table.label\":\"Related_Accounts__c\"}",s);
 					    ...
 					    boolean forceLoopOpportunity = false;
 							...
 							OpportunityStruct OpportunityObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		...
                        		    		OpportunityHashKey.ExternalIdSplit__c = row4.Opportunity__c;
				           		...
				           		if(tHash_Lookup_Opportunity != null && tHash_Lookup_Opportunity.getCount(OpportunityHashKey) > 1) { // G 071
			  							
			  						
									 		
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'Opportunity' and it contains more one result from keys :  Opportunity.ExternalIdSplit__c = '" + OpportunityHashKey.ExternalIdSplit__c + "'");
								} // G 071
							...
							Opportunity = OpportunityDefault;
								...
								if (tHash_Lookup_Opportunity !=null && tHash_Lookup_Opportunity.hasNext()) { // G 099
								
							
								
								fromLookup_Opportunity = tHash_Lookup_Opportunity.next();
 					    ...
 					    boolean forceLoopAccount = false;
 							...
 							AccountStruct AccountObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		...
                        		    		AccountHashKey.ExternalIdSplit__c = row4.Account__c;
 					    ...
 					    boolean forceLoopOwner = false;
 							...
 							OwnerStruct OwnerObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		...
                        		    		OwnerHashKey.ExternalIdSplit__c = row4.OwnerId;
				           		...
				           		if(tHash_Lookup_Owner != null && tHash_Lookup_Owner.getCount(OwnerHashKey) > 1) { // G 071
			  							
			  						
									 		
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'Owner' and it contains more one result from keys :  Owner.ExternalIdSplit__c = '" + OwnerHashKey.ExternalIdSplit__c + "'");
								} // G 071
							...
							Owner = OwnerDefault;
								...
								if (tHash_Lookup_Owner !=null && tHash_Lookup_Owner.hasNext()) { // G 099
...
// # Output table : 'RelatedAccount'
RelatedAccount_tmp.OwnerId = Owner.Id ;
RelatedAccount_tmp.CurrencyIsoCode = row4.CurrencyIsoCode;
RelatedAccount_tmp.CreatedDate = row4.CreatedDate ;
RelatedAccount_tmp.CreatedById = CreatedBy.Id ;
RelatedAccount_tmp.LastModifiedDate = row4.LastModifiedDate;
RelatedAccount_tmp.LastModifiedById = ModifiedBy.Id ;
RelatedAccount_tmp.Account__c = Account.Id ;
RelatedAccount_tmp.ExternalIdSAMS__c = row4.ExternalIdSAMS__c;
RelatedAccount_tmp.Opportunity__c = Opportunity.Id ;
RelatedAccount_tmp.Role__c = row4.Role__c;
RelatedAccount_tmp.ExternalIdSplit__c = row4.Id ;
RelatedAccount = RelatedAccount_tmp;
// ###############################
 ...
 */
// Start of branch "RelatedAccount"
if(RelatedAccount != null) { 
	...
	currentComponent="tSalesforceOutput_1";
			...
			//RelatedAccount
				...
				if(execStat){
					runStat.updateStatOnConnection("RelatedAccount"+iterateId,1, 1);
				} 
            ...
            incomingEnforcer_tSalesforceOutput_1.createNewRecord();
                    ...
                    if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("OwnerId") != null){
                        incomingEnforcer_tSalesforceOutput_1.put("OwnerId", RelatedAccount.OwnerId);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("CurrencyIsoCode") != null){
                        incomingEnforcer_tSalesforceOutput_1.put("CurrencyIsoCode", RelatedAccount.CurrencyIsoCode);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("CreatedDate") != null){
                        incomingEnforcer_tSalesforceOutput_1.put("CreatedDate", RelatedAccount.CreatedDate);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("CreatedById") != null){
                        incomingEnforcer_tSalesforceOutput_1.put("CreatedById", RelatedAccount.CreatedById);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("LastModifiedDate") != null){
                        incomingEnforcer_tSalesforceOutput_1.put("LastModifiedDate", RelatedAccount.LastModifiedDate);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("LastModifiedById") != null){
                        incomingEnforcer_tSalesforceOutput_1.put("LastModifiedById", RelatedAccount.LastModifiedById);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("Account__c") != null){
                        incomingEnforcer_tSalesforceOutput_1.put("Account__c", RelatedAccount.Account__c);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("ExternalIdSAMS__c") != null){
                        incomingEnforcer_tSalesforceOutput_1.put("ExternalIdSAMS__c", RelatedAccount.ExternalIdSAMS__c);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("Opportunity__c") != null){
                        incomingEnforcer_tSalesforceOutput_1.put("Opportunity__c", RelatedAccount.Opportunity__c);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("Role__c") != null){
                        incomingEnforcer_tSalesforceOutput_1.put("Role__c", RelatedAccount.Role__c);
                    }
                    //skip the put action if the input column doesn't appear in component runtime schema
                    if (incomingEnforcer_tSalesforceOutput_1.getRuntimeSchema().getField("ExternalIdSplit__c") != null){
                        incomingEnforcer_tSalesforceOutput_1.put("ExternalIdSplit__c", RelatedAccount.ExternalIdSplit__c);
                    }
	...
	currentComponent="tSalesforceOutput_1";
        ...
        outgoingEnforcer_tSalesforceOutput_1OutMain.setWrapped(factory_tSalesforceOutput_1OutMain.convertToAvro(outgoingMain_tSalesforceOutput_1));
                Object columnValue_0_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain.get(0);
                        row5.OwnerId = (String) (columnValue_0_tSalesforceOutput_1OutMain);
                Object columnValue_1_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain.get(1);
                        row5.CurrencyIsoCode = (String) (columnValue_1_tSalesforceOutput_1OutMain);
                Object columnValue_2_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain.get(2);
                        row5.CreatedDate = (java.util.Date) (columnValue_2_tSalesforceOutput_1OutMain);
                Object columnValue_3_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain.get(3);
                        row5.CreatedById = (String) (columnValue_3_tSalesforceOutput_1OutMain);
                Object columnValue_4_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain.get(4);
                        row5.LastModifiedDate = (java.util.Date) (columnValue_4_tSalesforceOutput_1OutMain);
                Object columnValue_5_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain.get(5);
                        row5.LastModifiedById = (String) (columnValue_5_tSalesforceOutput_1OutMain);
                Object columnValue_6_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain.get(6);
                        row5.Account__c = (String) (columnValue_6_tSalesforceOutput_1OutMain);
                Object columnValue_7_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain.get(7);
                        row5.ExternalIdSAMS__c = (String) (columnValue_7_tSalesforceOutput_1OutMain);
                Object columnValue_8_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain.get(8);
                        row5.Opportunity__c = (String) (columnValue_8_tSalesforceOutput_1OutMain);
                Object columnValue_9_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain.get(9);
                        row5.Role__c = (String) (columnValue_9_tSalesforceOutput_1OutMain);
                Object columnValue_10_tSalesforceOutput_1OutMain = outgoingEnforcer_tSalesforceOutput_1OutMain.get(10);
                        row5.ExternalIdSplit__c = (String) (columnValue_10_tSalesforceOutput_1OutMain);
            			} else {
            				row5 = null;
            			}
        ...
        outgoingEnforcer_tSalesforceOutput_1OutReject.setWrapped(factory_tSalesforceOutput_1OutReject.convertToAvro(outgoingReject_tSalesforceOutput_1));
                Object columnValue_0_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(0);
                        row6.OwnerId = (String) (columnValue_0_tSalesforceOutput_1OutReject);
                Object columnValue_1_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(1);
                        row6.CurrencyIsoCode = (String) (columnValue_1_tSalesforceOutput_1OutReject);
                Object columnValue_2_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(2);
                        row6.CreatedDate = (java.util.Date) (columnValue_2_tSalesforceOutput_1OutReject);
                Object columnValue_3_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(3);
                        row6.CreatedById = (String) (columnValue_3_tSalesforceOutput_1OutReject);
                Object columnValue_4_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(4);
                        row6.LastModifiedDate = (java.util.Date) (columnValue_4_tSalesforceOutput_1OutReject);
                Object columnValue_5_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(5);
                        row6.LastModifiedById = (String) (columnValue_5_tSalesforceOutput_1OutReject);
                Object columnValue_6_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(6);
                        row6.Account__c = (String) (columnValue_6_tSalesforceOutput_1OutReject);
                Object columnValue_7_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(7);
                        row6.ExternalIdSAMS__c = (String) (columnValue_7_tSalesforceOutput_1OutReject);
                Object columnValue_8_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(8);
                        row6.Opportunity__c = (String) (columnValue_8_tSalesforceOutput_1OutReject);
                Object columnValue_9_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(9);
                        row6.Role__c = (String) (columnValue_9_tSalesforceOutput_1OutReject);
                Object columnValue_10_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(10);
                        row6.ExternalIdSplit__c = (String) (columnValue_10_tSalesforceOutput_1OutReject);
                Object columnValue_11_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(11);
                        row6.errorCode = (String) (columnValue_11_tSalesforceOutput_1OutReject);
                Object columnValue_12_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(12);
                        row6.errorFields = (String) (columnValue_12_tSalesforceOutput_1OutReject);
                Object columnValue_13_tSalesforceOutput_1OutReject = outgoingEnforcer_tSalesforceOutput_1OutReject.get(13);
                        row6.errorMessage = (String) (columnValue_13_tSalesforceOutput_1OutReject);
            			} else {
            				row6 = null;
            			}
				...
				if(execStat){
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row5.Account__c != null) {
                        sb_tFileOutputDelimited_1.append(
                            row5.Account__c
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row5.ExternalIdSAMS__c != null) {
                        sb_tFileOutputDelimited_1.append(
                            row5.ExternalIdSAMS__c
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row5.Opportunity__c != null) {
                        sb_tFileOutputDelimited_1.append(
                            row5.Opportunity__c
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row5.Role__c != null) {
                        sb_tFileOutputDelimited_1.append(
                            row5.Role__c
                        );
                            }
				...
				if(execStat){
                    ...
                    StringBuilder sb_tFileOutputDelimited_2 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_2.append(
                            ...
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row6.Account__c != null) {
                        sb_tFileOutputDelimited_2.append(
                            row6.Account__c
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row6.ExternalIdSAMS__c != null) {
                        sb_tFileOutputDelimited_2.append(
                            row6.ExternalIdSAMS__c
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row6.Opportunity__c != null) {
                        sb_tFileOutputDelimited_2.append(
                            row6.Opportunity__c
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row6.Role__c != null) {
                        sb_tFileOutputDelimited_2.append(
                            row6.Role__c
                        );
                            }
...
if(resultMap_tSalesforceOutput_1!=null) {
	for(java.util.Map.Entry<String,Object> entry_tSalesforceOutput_1 : resultMap_tSalesforceOutput_1.entrySet()) {
		...
		default :
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("RelatedAccount"+iterateId,2, 0); 
			 	}
			}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_CreatedBy";
		...
		int tos_count_tAdvancedHash_CreatedBy = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row4,CreatedBy,ModifiedBy,Opportunity,Account,Owner) outputs:(RelatedAccount)
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row1Struct> tHashFile_tHashInput_2 = mf_tHashInput_2.getAdvancedMemoryHashFile("tHashFile_LOAD_RelatedAccount_" + pid +"_tHashOutput_1");
 ...
 */
	...
	currentComponent="tHashInput_2";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_LOAD_RelatedAccount_" + pid +"_tHashOutput_1");
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row1Struct> tHashFile_tHashInput_3 = mf_tHashInput_3.getAdvancedMemoryHashFile("tHashFile_LOAD_RelatedAccount_" + pid +"_tHashOutput_1");
...
public static class OpportunityStruct implements routines.system.IPersistableComparableLookupRow<OpportunityStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_LOAD_RelatedAccount = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_LOAD_RelatedAccount = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
...
public void tHashInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		start_Hash.put("tAdvancedHash_Opportunity", System.currentTimeMillis());
	...
	currentComponent="tAdvancedHash_Opportunity";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("Opportunity" + iterateId, 0, 0);
		...
		int tos_count_tAdvancedHash_Opportunity = 0;
			   		...
			   		// source node:tHashInput_4 - inputs:(after_tSalesforceInput_4) outputs:(Opportunity,Opportunity) | target node:tAdvancedHash_Opportunity - inputs:(Opportunity) outputs:()
			   		// linked node: tMap_1 - inputs:(row4,CreatedBy,ModifiedBy,Opportunity,Account,Owner) outputs:(RelatedAccount)
			   
			   		org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_Opportunity = 
			   			org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
	   			...
	   			org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<OpportunityStruct> tHash_Lookup_Opportunity =org.talend.designer.components.lookup.memory.AdvancedMemoryLookup.
		   	   	   ...
		   	   	   globalMap.put("tHash_Lookup_Opportunity", tHash_Lookup_Opportunity);
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row2Struct> tHashFile_tHashInput_4 = mf_tHashInput_4.getAdvancedMemoryHashFile("tHashFile_LOAD_RelatedAccount_" + pid +"_tHashOutput_3");
 ...
 */
	...
	currentComponent="tAdvancedHash_Opportunity";
			...
			//Opportunity
				...
				if(execStat){
					runStat.updateStatOnConnection("Opportunity"+iterateId,1, 1);
				} 
 ...
 */
	...
	currentComponent="tHashInput_4";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_LOAD_RelatedAccount_" + pid +"_tHashOutput_3");
...
tHash_Lookup_Opportunity.endPut();
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("Opportunity"+iterateId,2, 0); 
			 	}
			}
...
end_Hash.put("tAdvancedHash_Opportunity", System.currentTimeMillis());
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row3Struct> tHashFile_tHashInput_1 = mf_tHashInput_1.getAdvancedMemoryHashFile("tHashFile_LOAD_RelatedAccount_" + pid +"_tHashOutput_2");
 ...
 */
	...
	currentComponent="tHashInput_1";
		...
		org.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove("tHashFile_LOAD_RelatedAccount_" + pid +"_tHashOutput_2");
...
public static class OwnerStruct implements routines.system.IPersistableComparableLookupRow<OwnerStruct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_LOAD_RelatedAccount = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_LOAD_RelatedAccount = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
...
public void tHashInput_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		start_Hash.put("tAdvancedHash_Owner", System.currentTimeMillis());
	...
	currentComponent="tAdvancedHash_Owner";
			...
			if (execStat) {
				if(resourceMap.get("inIterateVComp") == null){
						...
						runStat.updateStatOnConnection("Owner" + iterateId, 0, 0);
		...
		int tos_count_tAdvancedHash_Owner = 0;
			   		...
			   		// source node:tHashInput_5 - inputs:(after_tSalesforceInput_4) outputs:(Owner,Owner) | target node:tAdvancedHash_Owner - inputs:(Owner) outputs:()
			   		// linked node: tMap_1 - inputs:(row4,CreatedBy,ModifiedBy,Opportunity,Account,Owner) outputs:(RelatedAccount)
			   
			   		org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE matchingModeEnum_Owner = 
			   			org.talend.designer.components.lookup.common.ICommonLookup.MATCHING_MODE.UNIQUE_MATCH;
...
org.talend.designer.components.hashfile.memory.AdvancedMemoryHashFile<row1Struct> tHashFile_tHashInput_5 = mf_tHashInput_5.getAdvancedMemoryHashFile("tHashFile_LOAD_RelatedAccount_" + pid +"_tHashOutput_1");
if(tHashFile_tHashInput_5==null) {
	throw new RuntimeException("The hash is not initialized : The hash must exist before you read from it");
}
java.util.Iterator<row1Struct> iterator_tHashInput_5 = tHashFile_tHashInput_5.iterator();
while (iterator_tHashInput_5.hasNext()) {
    row1Struct next_tHashInput_5 = iterator_tHashInput_5.next();

	Owner.Id = next_tHashInput_5.Id;
	Owner.ExternalIdSplit__c = next_tHashInput_5.ExternalIdSplit__c;
 ...
 */
	...
	currentComponent="tAdvancedHash_Owner";
			...
			//Owner
				...
				if(execStat){
					runStat.updateStatOnConnection("Owner"+iterateId,1, 1);
				} 
...
tHash_Lookup_Owner.endPut();
			...
			if(execStat){
				if(resourceMap.get("inIterateVComp") == null || !((Boolean)resourceMap.get("inIterateVComp"))){
			 		runStat.updateStatOnConnection("Owner"+iterateId,2, 0); 
			 	}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final LOAD_RelatedAccount LOAD_RelatedAccountClass = new LOAD_RelatedAccount();

        int exitCode = LOAD_RelatedAccountClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = LOAD_RelatedAccount.class.getClassLoader().getResourceAsStream("local_project/load_relatedaccount_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = LOAD_RelatedAccount.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : LOAD_RelatedAccount");
        }
...
/************************************************************************************************
 *     479786 characters generated by Talend Open Studio for Data Integration 
 *     on the 7 novembre 2019 11:18:25 CET
 ************************************************************************************************/