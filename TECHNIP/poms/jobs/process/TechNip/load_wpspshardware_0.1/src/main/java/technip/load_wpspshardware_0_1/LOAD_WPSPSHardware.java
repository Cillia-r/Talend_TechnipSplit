	...
	public void tHashInput_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_1 -
				// inputs:(row2,WPdetails,CreatedBy,ModifiedBy,SPSProduct,RecordType)
				// outputs:(WPSPS)
...
/************************************************************************************************
 * 948847 characters generated by Talend Open Studio for Data Integration on the
 * 20 décembre 2019 12:46:38 CET
 ************************************************************************************************/
