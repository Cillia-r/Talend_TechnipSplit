			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (; available_tSalesforceInput_1; available_tSalesforceInput_1 = reader_tSalesforceInput_1
					...
					{ // start of Var scope
						...
						WPSPS_tmp.SubseaStockingTree__c = row2.SubseaStockingTree__c;
					...
					if (WPSPS != null) {
						...
						{ // start of Var scope
							...
							WPSPSHdr_tmp.SubseaStockingTree__c = WPSPS.SubseaStockingTree__c;
...
/************************************************************************************************
 * 948266 characters generated by Talend Open Studio for Data Integration on the
 * 18 novembre 2019 17:08:39 CET
 ************************************************************************************************/
