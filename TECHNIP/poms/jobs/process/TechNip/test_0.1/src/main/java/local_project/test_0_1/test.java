	...
	public void tFileInputDelimited_1Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "Id", "Name", "Prenom",
						"Age", });
				...
				try {
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/Cillia/Desktop/test.csv",
								"ISO-8859-15", ";", "\n", true, 1, 0, -1, -1,
								false);
					} catch (java.lang.Exception e) {
							...
							while ((tHash_Lookup_row4 != null && tHash_Lookup_row4
								...
								{ // start of Var scope
									...
									if (!rejectedInnerJoin_tMap_1) {
										...
										// # Output table : 'out'
										out_tmp.Id = Numeric.sequence("s1", 1,
												1);
										out_tmp.Name = row1.Name;
	...
	public void tFileInputDelimited_2Process(
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tLogRow_3 - inputs:(row3) outputs:(row4,row4) |
				// target node:tAdvancedHash_row4 - inputs:(row4) outputs:()
				// linked node: tMap_1 - inputs:(row1,row4) outputs:(out)
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = "C:/Users/Cillia/Desktop/test1.csv";
					...
					try {
						fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/Cillia/Desktop/test1.csv",
								"ISO-8859-15", ";", "\n", true, 1, 0, -1, -1,
								false);
					} catch (java.lang.Exception e) {
					...
					while (fid_tFileInputDelimited_2 != null
						...
						try {
							...
							row3.Prenom = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 3;

							row3.Age = fid_tFileInputDelimited_2
									.get(columnIndexWithD_tFileInputDelimited_2);
					...
					if (!((Object) ("C:/Users/Cillia/Desktop/test1.csv") instanceof java.io.InputStream)) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = test.class.getClassLoader()
					.getResourceAsStream(
							"local_project/test_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 110957 characters generated by Talend Open Studio for Data Integration on the
 * 18 novembre 2019 13:38:20 CET
 ************************************************************************************************/
